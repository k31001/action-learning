...
export const DRIVING_FORCES_DATA = {
  ...
  drivers: [
    ...
    },
    {
      ...
      currentPosition: '[2026-08-18 정기 재평가] DF2 0.5 유지 — 08-11 이후 git log 변경분(제품믹스·역사 리서치·SP-2 트랙·outputs·회의록) 전부에서 신규 미중 실현 정책 사실 0건 → 위치·방향 유지. MATCH(H.R.8170) 본회의 표결 movement 없음·CXMT HBM 대규모 양산 미확정·애플–CXMT 리트머스 테스트 단계·신규 수출통제 없음. SSD 경쟁 재편(WD–SanDisk 분사·Micron Crucial 철수)은 산업 구조 렌즈일 뿐 지정학 축 신호 아님. SP-2 트랙에서 DF2는 배경 변수로 강등되어 SP-1 위치 무영향. [2026-08-11 정기 재평가] DF2 0.5 유지 — 신규 미중 실현 사실 부재(크리스 밀러 초크포인트 관찰은 외부 해석). [2026-08-04 정기 재평가] DF2 0.5 유지 — 07-28 이후 변경분은 내부 인터뷰 2건뿐, 신규 미중 실현 사실 부재. 이창수 부사장(08-03) "중국 비동조화"(미주 AI 꺼져도 중국은 자동 연동 아님 — CXMT·YMTC·로컬 GPU에 국가적 총력, 인민 행복+미국 초월 동기)·미주 우선 집중과 동시에 중국 빅테크(바이트댄스·알리바바·텐센트) 페이즈2 멀티이어 진행은 관리된 공존(0.5) 정합 전망 — 실현된 정책 사실이 아닌 전망이므로 위치·방향 무이동. MATCH·CXMT HBM·애플–CXMT 리트머스 상태 무변화. [2026-07-28 정기 재평가] DF2 0.5 유지 — 07-21~28 창 내 신규 미중 실현 사실 부재. MATCH 법안(H.R.8170) 위원회 통과 단계 유지·본회의 표결 movement 없음(congress.gov)·CXMT HBM 대규모 양산 미확정·애플–CXMT 테스트 단계·신규 수출통제/블랙리스트 조치 없음 → 방향·위치 모두 유지. [2026-07-21 정기 재평가] DF2 0.5 유지 — 이번 주 신규 미중 실현 사실 부재. MATCH 법안은 위원회 통과 후 본회의 표결 전 단계 유지(주 분기점)·CXMT는 2026년 내 HBM 양산 도달 불투명(일정 지연)으로 오히려 공존 쪽 압력 미증가. 애플–CXMT 리트머스(승인/차단)도 미해결 유지 → 방향·위치 모두 유지. [2026-07-14 재평가] DF2 1.0→0.5 — 관리된 공존 쪽으로 소폭 이동. 애플–CXMT 건(FT 07-08): 애플이 중국 내수용 기기에 中 CXMT DRAM 기술 검증 착수 + 미 행정부에 사용 승인 로비, 로이터(2026-06)는 행정부가 대베이징 긴장 회피로 CXMT 추가 블랙리스트 등재 보류 → 실현된 사실 2건 모두 공존 쪽 약한 신호. 절제: 아직 테스트 단계·1260H 등재·의회 반대·YMTC 2022 무산 전철 리스크 상존 → 승인/차단 리트머스 미해결로 이동폭 소폭. 신규 트리거 apple_cxmt_approved + EWI cxmt_apple_qualification로 양방향 추적. 두 극단 사이 긴장된 중간지점, 2026 MATCH 법안 통과가 여전히 주 분기점',
      poleA: {
        label: '전면 기술 디커플링',
