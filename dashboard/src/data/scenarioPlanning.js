  ...
  matrix: [
    {
      ...
      df1: 'AI 지속',     df2: '디커플링',
      probability: 26,  // 2026-07-28 유지(거시 축 무변화, in-window 신호는 DF1 정점 재확인). 2026-07-14 — 애플–CXMT 건으로 DF2 관리된 공존 쪽 이동 → AI-지속 행 내 A(디커플링)→B(공존) 재배분 27→26 (indicators.js 동기화)
