    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          {
            type: 'quote',
            text: '도출 원리 — 판정 ◎ 액션(구조 대응·역사이클 매수·재무 요새·다운턴 착공)의 공통 분모는 "다운턴을 버티는 시간이 아니라 사용하는 시간으로 썼다"는 것이다. §7 전략 2순위(역사이클 대상 교정)는 이 액션들의 직계 후손이고, A5(✕ 불발·2023-04 자진 철회)는 폐기·대체(3순위), A6(✕ 실기)은 반면교사(R&D 하한·별동대)로 역이용된다. 1순위(계약 바닥)만이 과거 액션 목록에 없는 신규다 — 효과가 분명했던 과거 액션들조차 전부 "다운턴 도착 후"의 대응이었지만, 계약 바닥은 도착 전에만 만들 수 있고 그 창이 지금 열려 있다.',
