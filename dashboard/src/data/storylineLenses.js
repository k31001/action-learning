    ...
    sections: [
        ...
        blocks: [
          ...
          },
          {
            ...
            rows: [
              ...
              ['CMO-4 (설계) · 다음 다운턴 (2028~29 창)', '§3의 6대 변화 — 절제 균형+CXMT · 계약 바닥 · 인증 게임 · 비동기 사이클 · CAPEX/ROI 경로 · 추격자 위치', '§5 액션 판정·§6 경쟁사 벤치마킹·§7의 감사 통과 메커니즘만 재조립 — 계약 바닥 선점 · 역사이클 대상 교정 · 치킨게임 봉인 · 맥락 EWI', '(목표) 매출 바닥이 계약으로 보장된 다운턴 · 다음 세대 인증 선점 · 절제 균형 유지', '과거 공식의 복제가 아니라, 맥락 감사를 통과한 재조립'],
            ],
          },
        ],
      },
      ...
      },
      {
        ...
        blocks: [
          ...
          {
            type: 'quote',
            text: '도출 원리 — 판정 ◎ 액션(구조 대응·역사이클 매수·재무 요새·다운턴 착공)의 공통 분모는 "다운턴을 버티는 시간이 아니라 사용하는 시간으로 썼다"는 것이다. §7 전략 2순위(역사이클 대상 교정)는 이 액션들의 직계 후손이고, △는 폐기·대체(3순위), ✕는 반면교사(R&D 하한·별동대)로 역이용된다. 1순위(계약 바닥)만이 과거 액션 목록에 없는 신규다 — 효과가 분명했던 과거 액션들조차 전부 "다운턴 도착 후"의 대응이었지만, 계약 바닥은 도착 전에만 만들 수 있고 그 창이 지금 열려 있다.',
            ...
            items: [
              {
                ...
                why: '§5 액션 목록의 유일한 공백이자 §6 B4(마이크론 계약·수요 선점 역순)가 이미 실증한 구조 — 과거 세 다운턴에 존재하지 않았던 새 메커니즘이며, 발화 조건(공급 부족 호황 + 고객의 물량 불안)이 지금만 성립하기 때문이다 — 고객이 스스로 선수금을 예치하고 다년 계약에 서명하는 국면은 다운턴이 시작되는 순간 끝난다. 과거 공식이 "폭락을 체력으로 버틴다"였다면, 새 공식은 "폭락이 매출에 도달하지 못하게 한다"다.',
                links: [
