...
export const KNOWLEDGE_GRAPH = {
  ...
  "hubs": [
    ...
    {
      "id": "strategies/invariant/rs2-barbell-portfolio.md",
      "title": "RS-2: 바벨 포트폴리오 전략 (Barbell Portfolio)",
      "degree": 18,
      "inDegree": 6
    },
    {
  ...
  "asymmetric": [
    ...
    {
      "from": "concepts/lta-to-sca-transition.md",
      "to": "strategies/core/current-state-mb4-custom-ai-memory.md"
    },
    {
      "from": "concepts/lta-to-sca-transition.md",
      "to": "strategies/invariant/rs3-customer-switching-cost.md"
    },
    {
      "from": "concepts/lta-to-sca-transition.md",
      "to": "strategies/invariant/rs8-structured-revenue-hedging.md"
