...
export const KNOWLEDGE_GRAPH = {
  ...
  "hubs": [
    ...
    {
      "id": "strategies/dev-org-transformation.md",
      "title": "개발실 체질 전환 전략 — 수주 이행자에서 기술 파트너로 (DT: Dev-org Transformation)",
      "degree": 17,
      "inDegree": 9
    }
  ],
