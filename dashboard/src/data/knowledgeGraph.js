...
export const KNOWLEDGE_GRAPH = {
  ...
  "hubs": [
    ...
    {
      "id": "entities/nvidia.md",
      "title": "NVIDIA Corporation",
      "degree": 16,
      "inDegree": 1
    },
    {
      "id": "concepts/ai-compute-economics-gap.md",
      "title": "AI 컴퓨트 경제학 갭 — Bain의 수요·자본·공급 프레임",
      "degree": 15,
      "inDegree": 7
    },
    {
      "id": "concepts/ai-datacenter-buildout.md",
      "title": "AI 데이터센터 착공 현황 — 메모리 수요 선행 지표",
      "degree": 15,
      "inDegree": 6
    },
    {
      "id": "concepts/demand-inflection-ewi.md",
      "title": "메모리 수요 변곡 조기경보 (Demand-Inflection EWI)",
      "degree": 15,
      "inDegree": 5
    },
    {
  ...
  "orphans": [],
  "isolated": [
    "benchmark/agri-hedging-to-memory-semi.md",
    "benchmark/cyclical-strategy-benchmark.md",
    "benchmark/upside-participation-hedging.md",
    "driving-forces/impact-uncertainty-matrix.md",
    "scenarios/core-strategy-selection.md",
    "steep/environment.md",
    "steep/political.md",
    "steep/social.md",
    "steep/technology.md"
  ],
  ...
  "asymmetric": [
    ...
    {
      "from": "concepts/emerging-tech.md",
      "to": "strategies/core/current-state-se2-cxl-sig-leadership.md"
    },
    {
      "from": "concepts/emerging-tech.md",
    ...
    {
      "from": "entities/china-competitors.md",
      "to": "strategies/invariant/rs6-process-leadership.md"
    },
    {
      "from": "entities/china-competitors.md",
