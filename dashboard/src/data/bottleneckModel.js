...
export const MODEL_ASOF = '2026-09-01'
...
export const BOTTLENECKS = [
  {
    ...
    currentIndex: 76,
    indexNote: 'ERCOT가 2026-08-03 Abbott 주지사 지시로 신규 데이터센터 접속 절차를 전면 일시중단(감사 완료 시한 12-10) — 접속 신청 474GW 중 ~90%가 DC, Batch Zero 접속연구는 첫 마일스톤부터 지연. BNEF: 최대 49.8GW 지연·비용 최대 $15억 추가. 큐 적체(점증적 병목)에서 접속 절차 정지(레짐 전환)로 성격 악화 — 4대 병목 중 최초 Red 밴드 진입, 4개 점검 연속 재상승',
  ...
  },
  {
    ...
    currentIndex: 38,
    indexNote: 'Q2 2026 실적 시즌 완료 — 빅4(MS·Alphabet·Amazon·Meta) 2026 CapEx 가이던스 전원 추가 상향(합산 ~$745~750B, +82% YoY), 삭감 0건 재확인. HY OAS 안정 유지. 단 Meta FCF -91%·Amazon TTM FCF 적자 등 CapEx-FCF 다이버전스는 잔존 리스크',
  ...
  },
  {
    ...
    currentIndex: 48,
    indexNote: 'TSMC N3 월 웨이퍼 투입이 18만 장 목표를 원 예상보다 2~3개월 조기 달성 전망(2026 Q4 초, NVIDIA·AMD·Broadcom 주문 견인). N2는 현재 대만 5개 팹 합산 2만 장/월·연말 10만 장/월 목표 경로 순항. ASML High-NA 2029 연기 유지. 대만 집중(0.525/0.75)·지정학 리스크 잔존',
  ...
  },
  {
    ...
    currentIndex: 65,
    indexNote: 'TSMC CoWoS 수급 갭이 2026년 말까지 20%→10%로 축소된다는 최초의 정량 전망 확인(수율 98~99%). 삼성 HBM4(마이크로범프) 수율이 80% "골든수율"에 업계 예상보다 약 4개월 조기 도달(연말 목표 85%) — 적층 수율 드라이버의 구체적 완화 신호. 단 HBM4 하이브리드본딩은 3사 전원 여전히 마이크로범프 유지(HBM4E/5E 이연)·CoPoS 전면 양산도 2028~29로 불변',
...
export const DRIVERS_ASOF = '2026-09-01'
...
export const BOTTLENECK_DRIVERS = [
  ...
  { id: 'capex_guide', bottleneck: 'capex', depth: 1, name: 'capex 가이던스·발주 모멘텀', lead: '1~3분기', weight: 3, level: 'easing', trend: 'improving', ewiLink: 'capex_guide',
    note: "Q2 2026 실적 시즌 완료 — 빅4(MS·Alphabet·Amazon·Meta) 전원 추가 상향(합산 ~$745~750B, +82% YoY), 삭감 0건. Dell'Oro 2026 글로벌 DC CAPEX $1조 돌파(메모리 가격 인플레 명시적 요인). JPMorgan 2030 누적 $5.5조", src: '빅4 Q2 실적 콜(2026-07-29/30)·Dell\'Oro·JPMorgan' },
  ...
  { id: 'interconnect', bottleneck: 'power', depth: 1, name: '계통 접속 큐·지연일수', lead: '12~36개월', weight: 3, level: 'critical', trend: 'worsening',
    note: 'ERCOT가 2026-08-03 Abbott 주지사 지시로 신규 데이터센터 접속 절차를 전면 일시중단(감사 시한 12-10) — 접속 신청 474GW 중 ~90%가 DC. Batch Zero 접속연구 첫 마일스톤부터 지연. PJM은 2030년까지 최대 15GW 구조적 부족 경고 불변(신규공급 연2~3GW<신규부하 연5~7GW). 큐 적체(점증적)에서 접속 절차 정지(레짐 전환)로 성격 악화', src: '유틸리티·RTO 공시·Holland & Knight·Utility Dive 2026-08' },
  ...
  { id: 'node_ramp', bottleneck: 'foundry', depth: 1, name: 'N2/18A 선단 램프 진척', lead: '6~12개월', weight: 3, level: 'easing', trend: 'improving',
    note: 'N3 월 웨이퍼 투입이 18만 장 목표를 원 예상보다 2~3개월 조기 달성 전망(2026 Q4 초). N2는 현재 5개 팹 합산 2만 장/월·연말 10만 장/월 목표 경로 순항', src: 'tsmc.md·TrendForce 2026-08' },
  ...
  { id: 'cowos_util',  bottleneck: 'packaging', depth: 1, name: 'CoWoS 가동률·증설', lead: '3~9개월', weight: 3, level: 'tight', trend: 'improving', ewiLink: 'cowos',
    note: 'CoWoS 수급 갭이 2026년 말까지 20%→10%로 축소된다는 최초의 정량 전망 확인(TrendForce). 캐파 12만~14만 장/월+OSAT 5만~6만 장, 수율 98~99%. NVIDIA 배정 ~60% 확정 불변', src: 'TrendForce 2026-06/08·Silicon Analysts' },
  ...
  { id: 'stack_yield', bottleneck: 'packaging', depth: 2, parent: 'cowos_util', name: 'HBM 적층·테스트 수율 (TSV/KGD·16-Hi)', lead: '6~12개월', weight: 2, level: 'tight', trend: 'stable',
    note: '삼성 HBM4(마이크로범프) 수율이 80% "골든수율"에 업계 예상보다 약 4개월 조기 도달(연말 목표 85%, 3Q26 HBM4 매출 전분기 대비 3배+ 전망) — 부분 완화. 단 하이브리드본딩(16-Hi) 축은 여전히 시험수율 ~10%로 3사 전원 HBM4E/5E로 이연 — 완전한 완화는 아님', src: 'TrendForce 2026-08·SemiEngineering', unknown: true },
