...
export const MODEL_ASOF = '2026-06-17'
...
export const BOTTLENECKS = [
  {
    ...
    currentIndex: 72,
    indexNote: 'ERCOT 대규모 부하 큐 410GW(87% DC)·Q1 2026 신규 198GW. PJM 2027~2028 용량 경매 6.6GW 미달·용량 가격 $333.44/MW-day(기록). 미국 변압기 납기 최장 4년(2026-05, pv-magazine). FERC 대규모 부하 접속 개혁 6월말 발표 예정(RM26-4-000) — 구조 완화까지 수년 소요. PJM 8년·DOE 100GW·ERCOT 145GW 기존 신호 유지. 요금이 아니라 접속 가능한 MW/GW의 실재적 한계',
  ...
  },
  {
    ...
    currentIndex: 40,
    indexNote: "SK하이닉스 Q1 2026 KRW 52.6조(+198% YoY)·72% 영업이익률(역대 최고). 빅4 Q1 CapEx 확정: Amazon $44.2B·Alphabet $35.67B·Microsoft $30.88B·Meta ~$20B(합산 YoY +77%). 전체 하이퍼스케일러 $782B(Dell'Oro) 재확인. Google Cloud +110%·Azure +84%·AWS +28% ROI 실현. HBM 3사 2026 전량 완판·2027 선예약 개시. NVIDIA Rubin Q3 풀 프로덕션. ABS·SPV 의존 잔존",
  ...
  },
  {
    ...
    currentIndex: 50,
    indexNote: 'NVIDIA Rubin 풀 프로덕션 진입·Q3 2026 출하 확정(Jensen Huang 2026-06-05 GTC Taipei). 3사 HBM4 인증 완료(Samsung·SK·Micron). TSMC N2 50K→140K WPM 순항·TSMC Q1 $35.9B 최고. TSMC 18개 신규 팹·첨단 패키징 시설 건설. 대만 집중(0.525/0.75)·지정학 리스크 잔존',
  ...
  },
  {
    ...
    currentIndex: 66,
    indexNote: 'TSMC OSAT 외주 신규: Amkor 180~190K+SPIL 60~80K 웨이퍼/년(2026~) 추가로 총 CoWoS 생산능력 대폭 확대. TSMC CoWoS 내부 130K WPM 확정·CoPoS 완공. 선진 패키징 >10% 매출. NVIDIA CoWoS 60%+ 점유(2026~2027). CC Wei "2026 sold out" 유지. 외주화로 실질 공급 여력 증가 — 중기 완화 가속',
...
export const DRIVERS_ASOF = '2026-06-17'
...
export const BOTTLENECK_DRIVERS = [
  ...
  { id: 'capex_guide', bottleneck: 'capex', depth: 1, name: 'capex 가이던스·발주 모멘텀', lead: '1~3분기', weight: 3, level: 'easing', trend: 'stable', ewiLink: 'capex_guide',
    note: "빅4 Q1 2026 CapEx 확정: Amazon $44.2B·Alphabet $35.67B·Microsoft $30.88B·Meta ~$20B(합산 YoY +77%). 풀이어 가이던스: Meta $125~145B·Google ~$185B·Amazon $200B. 전체 하이퍼스케일러 $782B(Dell'Oro) 재확인. NVIDIA Rubin Q3 풀 프로덕션", src: '빅4 분기 콜·Statista·Dell\'Oro 2026-06' },
  ...
  { id: 'ai_revenue',  bottleneck: 'capex', depth: 2, parent: 'hyp_fcf', name: 'AI 기업 매출·이익 (OpenAI·Anthropic·xAI·Google)', lead: '12~18개월', weight: 3, level: 'neutral', trend: 'stable',
    note: 'SK하이닉스 Q1 KRW 52.6조(+198% YoY)·72% 영업이익률. GCloud +110%·Azure +84%·AWS +28%(Q1 2026). Micron Q3 FY26 $33.5B(역대최고)·HBM3E 완판. HBM 전량 완판·2027 선예약 개시 — ROI 실현 가시화 강화. MIT 95% ROI 미실현·프런티어 랩 적자 잔존', src: 'ai-demand-sustainability.md·Micron IR·SK hynix IR 2026-06' },
  ...
  { id: 'interconnect', bottleneck: 'power', depth: 1, name: '계통 접속 큐·지연일수', lead: '12~36개월', weight: 3, level: 'critical', trend: 'worsening',
    note: 'PJM 평균 8년 확정·선진국 허브 7~10년(최장 13년). ERCOT 큐 410GW(87% DC)·Q1 2026 신규 198GW. PJM 2027~28 용량 6.6GW 미달·가격 $333.44/MW-day 기록. DOE 100GW(50% DC)·ERCOT 145GW(2031). 변압기 리드타임 최장 4년(2026-05). FERC RM26-4 6월말 개혁 예정(구조 완화 수년 소요)', src: '유틸리티·RTO 공시·IEA·FERC·pv-magazine 2026-05' },
  ...
  { id: 'cowos_util',  bottleneck: 'packaging', depth: 1, name: 'CoWoS 가동률·증설', lead: '3~9개월', weight: 3, level: 'tight', trend: 'improving', ewiLink: 'cowos',
    note: 'TSMC OSAT 외주 신규: Amkor 180~190K+SPIL 60~80K 웨이퍼/년 추가. TSMC 내부 130K WPM 확정·CoPoS 완공. 선진 패키징 >10% 매출. NVIDIA 60%+ CoWoS 점유. CC Wei "2026 sold out" 유지·외주화로 실질 공급 확대', src: 'TSMC transcript·GlobalSemiResearch·digitimes 2026-06-17' },
