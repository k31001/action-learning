...
export const MODEL_ASOF = '2026-06-15'
...
export const BOTTLENECKS = [
  {
    ...
    currentIndex: 72,
    indexNote: 'Microsoft Azure $80B 미충족 백로그 — "전력 가용성 부족이 원인, 수요 약세 아님". 미국 유틸리티 5사 $1.4T DC 에너지 투자. BTM(현장 자체발전) 2028년 DC 용량의 30% — 그리드 우회 구조화. FERC 대형 부하 신속처리 지시(2026-04-30). PJM 평균 8년·DOE 100GW·ERCOT 145GW. DC 전력 23→42→76GW(연말 예상)',
  ...
  },
  {
    ...
    currentIndex: 38,
    indexNote: "SK하이닉스 Q1 2026: 매출 52.6조·영업이익 37.6조(마진 72%) — 반도체 역사상 최고 단분기 수익성. 삼성 DS OP 53.7조(+49배 YoY). 빅테크 AI CapEx 2027년 $1조 돌파 전망(CNBC 2026-04-30). Big4 $710B 확정. GCloud +110%·Azure +84%·AWS +28%. ABS·SPV 의존 잔존",
  ...
  },
  {
    ...
    currentIndex: 50,
    indexNote: 'TSMC N2 볼륨 프로덕션 공식 진입·2026말 10만 WPM 목표. CoWoS 2026년 65만→2027년 84만 장 경로 확인(+76%/+29%). Rubin Ultra 듀얼다이 구성(CoWoS-L 수율로 쿼드→듀얼 스케일백). N3 fully booked 유지. 대만 집중(0.525/0.75)·지정학 리스크 잔존',
  ...
  },
  {
    ...
    currentIndex: 65,
    indexNote: 'CoWoS 2026년 65만 장·2027년 84만 장(+29%) 경로 확정. NVIDIA 3사 HBM4(Samsung·SK·Micron) 인증 완료·Q3 출하 개시. Samsung HBM4 11.7Gb/s NVIDIA 테스트 통과. Rubin Ultra 16-Hi 30μm 박막화 과제(HBM5 전환 선행 도전). Rubin 목표 150만 대 유지',
...
export const DRIVERS_ASOF = '2026-06-15'
...
export const BOTTLENECK_DRIVERS = [
  ...
  { id: 'capex_guide', bottleneck: 'capex', depth: 1, name: 'capex 가이던스·발주 모멘텀', lead: '1~3분기', weight: 3, level: 'easing', trend: 'stable', ewiLink: 'capex_guide',
    note: "빅4 $710B 확정(Alphabet $185B·Amazon $200B·Meta $135B·Microsoft $190B). 전체 $782B(Dell'Oro). CNBC: 빅테크 AI CapEx 2027년 $1조 돌파 전망(2026-04-30). Q1 분기 배정: Amazon $44.2B·Alphabet $35.7B·Microsoft $30.9B·Meta ~$20B", src: '빅4 분기 콜·Statista·Dell\'Oro·CNBC' },
  ...
  { id: 'ai_revenue',  bottleneck: 'capex', depth: 2, parent: 'hyp_fcf', name: 'AI 기업 매출·이익 (OpenAI·Anthropic·xAI·Google)', lead: '12~18개월', weight: 3, level: 'neutral', trend: 'improving',
    note: 'SK하이닉스 Q1 2026 OP 37.6조 원(72% 마진)·삼성 DS OP 53.7조(+49배) — 반도체 수익성이 AI ROI 실현의 가장 직접 확인. GCloud +110%·Azure +84%·AWS +28%(Q1 2026). Micron $33.5B(역대최고)·HBM3E 완판. MIT 95% ROI 미실현·프런티어 랩 적자는 잔존', src: 'ai-demand-sustainability.md·Micron IR·SK hynix IR·Samsung IR' },
  ...
  { id: 'interconnect', bottleneck: 'power', depth: 1, name: '계통 접속 큐·지연일수', lead: '12~36개월', weight: 3, level: 'critical', trend: 'worsening',
    note: 'Microsoft Azure $80B 미충족 백로그 — "전력 가용성 부족이 직접 원인". 미국 유틸리티 5사 $1.4T AI DC 에너지 투자. FERC 대형 부하 신속처리 지시(2026-04-30, 긍정 정책이나 공사 리드타임 7~13년). PJM 평균 8년 확정·선진국 허브 7~10년. 대기열 2,600GW. DOE 100GW·ERCOT 145GW(2031). BTM 2028년 30% — 그리드 우회 구조화', src: '유틸리티·RTO·FERC·Tech-Insider·DataCenter Knowledge' },
  ...
  { id: 'cowos_util',  bottleneck: 'packaging', depth: 1, name: 'CoWoS 가동률·증설', lead: '3~9개월', weight: 3, level: 'tight', trend: 'improving', ewiLink: 'cowos',
    note: 'CoWoS 2026년 65만 장(+76%)·2027년 84만 장(+29%) 경로 확정. NVIDIA 2026년 CoWoS 총 할당량 ~60% 독점 확보(2027년까지). TSMC 130K WPM 목표 확정. 3사 HBM4(Samsung·SK·Micron) 인증 완료·Q3 출하. Samsung 11.7Gb/s 통과. 여전히 fully booked이나 완화 가속', src: 'Bitget News·TSMC transcript·TechTimes·TrendForce' },
  ...
  { id: 'stack_yield', bottleneck: 'packaging', depth: 2, parent: 'cowos_util', name: 'HBM 적층·테스트 수율 (TSV/KGD·16-Hi)', lead: '6~12개월', weight: 2, level: 'tight', trend: 'worsening',
    note: 'Rubin Ultra HBM4 16-Hi: 전체 패키지 720μm 이내에 맞추기 위해 다이당 30μm 이하 박막화 필요 — 기술적 도전. Rubin Ultra 듀얼다이로 스케일백(CoWoS-L 수율). Samsung HBM4 11.7Gb/s 통과(긍정). 미지수 플래그 유지', src: 'SemiAnalysis·TechTimes·Bitget News', unknown: true },
