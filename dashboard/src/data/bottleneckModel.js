...
export const MODEL_ASOF = '2026-06-21'
...
export const BOTTLENECKS = [
  {
    ...
    currentIndex: 73,
    indexNote: '변압기·스위치기어 리드타임 160주+(2025년 150주→2026년 추가 악화)·스위치기어 2028년까지 완판. 북버지니아 2026-05 접속 신청 시 현실적 전력 확보 2030~2033년으로 구체화. 2026년 예정 AI DC의 30~50% 지연·취소. DOE: 2030년 미국 DC 전력 12%(현재 4%). PJM 평균 8년·선진국 허브 7~10년(최장 13년). 요금이 아니라 접속 가능한 MW/GW의 실재적 한계',
  ...
  },
  {
    ...
    currentIndex: 40,
    indexNote: "Amazon FY2026 전체 ~$200B·Alphabet $175~185B·Microsoft ~$190B·Meta $125~145B(추가 상향). 빅4 합계 $700~720B·전체 하이퍼스케일러 $782B(Dell'Oro). Micron FY2026 capex >$25B(이전 $20B, 25% 상향). H100 현물 ~$2.00/GPU·h(Vast.ai, 이전 $3.3 대비 하락) — ROI 이완 신호. GCloud+110%·Azure+84%·AWS+28% ROI 실현 강화. ABS·SPV 의존 잔존",
  ...
  },
  {
    ...
    currentIndex: 50,
    indexNote: 'TSMC N2 볼륨 생산 Q4 2025 돌입·2026년 100K WPM(Fab 20·22)·2027년 200K WPM. N2/A16 수주잔고 2028년까지 완판. Samsung·SK Hynix·Micron 전 3사 NVIDIA Vera Rubin HBM4 공급 인증 완료(Jensen Huang, 2026-06-05). 삼성 HBM4 로직 칩 수율 90%(이전 R&D 단계 ~50%에서 급개선). 대만 집중(0.525/0.75)·지정학 리스크 잔존',
  ...
  },
  {
    ...
    currentIndex: 64,
    indexNote: 'TSMC CoWoS 2026말 수급 갭 20%→10% 축소(TrendForce 2026-06-15). 2026말 115K~140K WPM·2027년 ~170K WPM 확인. CoPoS 파일럿 6월 완공·2028~29 양산. 선진 패키징 매출 >10%(2025년 8%에서). Rubin 200→150만 대 하향 수요 압력 완화. Amkor AZ 2028 초·SK 인디애나 2028말 일정 유지',
...
export const DRIVERS_ASOF = '2026-06-21'
...
export const BOTTLENECK_DRIVERS = [
  ...
  { id: 'capex_guide', bottleneck: 'capex', depth: 1, name: 'capex 가이던스·발주 모멘텀', lead: '1~3분기', weight: 3, level: 'easing', trend: 'stable', ewiLink: 'capex_guide',
    note: "Amazon FY2026 전체 ~$200B·Alphabet $175~185B·Microsoft ~$190B·Meta $125~145B(추가 상향). 빅4 합계 $700~720B·전체 하이퍼스케일러 $782B(Dell'Oro). Micron FY2026 >$25B. Q1 분기: Amazon $44.2B·Alphabet $35.7B·Microsoft $30.9B·Meta $20B", src: '빅4 분기 콜·Statista·Dell\'Oro·Micron IR 2026-06-21' },
  ...
  { id: 'gpu_rental',  bottleneck: 'capex', depth: 2, parent: 'capex_guide', name: 'GPU 임대가 (수요 청산가)', lead: '9~18개월', weight: 3, level: 'tight', trend: 'worsening', ewiLink: 'gpu_rental',
    note: 'H100 현물 ~$2.00/GPU·h(Vast.ai 기준, 중앙값 ~$2.99, 이전 $3.3 대비 하락) — neocloud 경제성 → GPU 발주의 최선행. 하락 추세는 공급 증가·수요 평준화 신호', src: 'Vast.ai 2026-06-21' },
  ...
  { id: 'interconnect', bottleneck: 'power', depth: 1, name: '계통 접속 큐·지연일수', lead: '12~36개월', weight: 3, level: 'critical', trend: 'worsening',
    note: 'PJM 평균 8년·선진국 허브 7~10년(최장 13년). 북버지니아 2026-05 신청 시 현실적 전력 확보 2030~2033년으로 구체화. 변압기 리드타임 160주+·스위치기어 2028년까지 완판. 2026년 예정 DC의 30~50% 지연·취소. 대기열 2,600GW·ERCOT 410GW(87% DC). DOE 2030 신규 100GW(50% DC 기인). 하이퍼스케일러 백악관 그리드 서약(2026-03)', src: '유틸리티·RTO 공시·IEA·WEF 2026·Tech-Insider·DataCenterKnowledge 2026-06-21' },
  ...
  { id: 'transformer',  bottleneck: 'power', depth: 2, parent: 'interconnect', name: '변압기·HV 케이블 리드타임', lead: '18~36개월', weight: 2, level: 'tight', trend: 'worsening',
    note: '변압기 리드타임 160주+(2025년 150주→2026년 추가 악화)·스위치기어 2028년까지 완판 — 접속 지연의 물리적 원인 다층화. 대기시간 최근 3년간 2배에서 추가 악화', src: 'energy-constraints.md·Tech-Insider 2026-06-21' },
  ...
  { id: 'node_ramp', bottleneck: 'foundry', depth: 1, name: 'N2/18A 선단 램프 진척', lead: '6~12개월', weight: 3, level: 'easing', trend: 'improving',
    note: 'TSMC N2 볼륨 생산 Q4 2025 돌입·2026년 100K WPM(Fab 20·Fab 22)·2027년 200K WPM. N2/A16 수주잔고 2028년까지 완판. 3사 모두 NVIDIA Vera Rubin HBM4 인증 완료(2026-06-05). 삼성 HBM4 로직 수율 90%', src: 'TSMC·Tom\'s Hardware·StreetInsider 2026-06-21' },
  ...
  { id: 'cowos_util',  bottleneck: 'packaging', depth: 1, name: 'CoWoS 가동률·증설', lead: '3~9개월', weight: 3, level: 'tight', trend: 'improving', ewiLink: 'cowos',
    note: 'TSMC CoWoS 2026말 수급 갭 20%→10% 축소(TrendForce 2026-06-15)·115K~140K WPM(2026말)·170K WPM(2027). CoPoS 파일럿 6월 완공·2028~29 양산. 선진 패키징 매출 >10%(2025년 8%). Rubin 200→150만 대 수요 완화 지속. Amkor AZ 2028·SK 인디애나 2028말', src: 'TrendForce 2026-06-15·Digitimes 2026-06-21' },
  ...
  { id: 'stack_yield', bottleneck: 'packaging', depth: 2, parent: 'cowos_util', name: 'HBM 적층·테스트 수율 (TSV/KGD·16-Hi)', lead: '6~12개월', weight: 2, level: 'tight', trend: 'worsening',
    note: '삼성 HBM4 로직 칩 수율 90% 달성(이전 R&D 단계 ~50%에서 급개선). 3사 모두 Rubin 인증 완료(2026-06-05). Micron HBM4E 수율 HBM3E 대비 빠른 램프 자신감. 16-Hi 전환 난도는 잔존하나 개선 중', src: 'StreetInsider·Tweaktown 2026-06-21', unknown: false },
