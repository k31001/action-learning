...
export const MODEL_ASOF = '2026-06-30'
...
export const BOTTLENECKS = [
  {
    ...
    currentIndex: 72,
    indexNote: 'PJM 용량권고(Capacity Advisory) 신메커니즘(06-24)·FERC 6개 RTO 대형부하 요금 개혁 명령(60일 기한)·NERC Level 3 경보(8/3 기한, "Computational Load Entity" 등록 추진)·美 가스 발전 증설 2026~27년 연 10GW 미만(2028+ 본격화). PJM 계통 접속 평균 8년·ERCOT 텍사스 145GW(2031). 요금이 아니라 접속 가능한 MW/GW의 실재적 한계',
  ...
  },
  {
    ...
    currentIndex: 39,
    indexNote: 'SemiAnalysis "美 DC 용량 절반 취소" 루머 반박 — 상위 2개 하이퍼스케일러 5GW+ 자체건설 진행, 6개월 전망 수정폭 1~5%(파이프라인 건재). NVIDIA 2H FY27 매출 컨센서스 +20% 상회 전망(HBM4 공급문제 해소). 빅4 $700~725B+Dell\'Oro $782B 가이던스 유지. ABS·SPV 자금조달 긴장은 잔존',
  ...
  },
  {
    ...
    currentIndex: 55,
    indexNote: 'NVIDIA 수요 재가속 신호 — HBM4 공급문제 해소로 Rubin 램프 가속, AI 배정 선단 캐파 압력 재상승(직전 "출하 22%로 하향" 완화 판단의 역전). N2 램프 순항·TSMC 5월 매출 사상 최고(YoY+30.1%) 유지. 대만 집중(0.525/0.75)·지정학 리스크 잔존',
  ...
  },
  {
    ...
    currentIndex: 65,
    indexNote: 'TrendForce: CoWoS 수급 갭 2026년 말까지 20%→10%로 축소 전망(06-15). 130K WPM 목표 유지. TSMC 5월 매출 사상 최고(YoY+30.1%)로 재확인. CoPoS 파일럿 6월 완공. 여전히 fully booked이나 완화 추세 가속',
...
export const DRIVERS_ASOF = '2026-06-30'
...
export const BOTTLENECK_DRIVERS = [
  ...
  { id: 'ai_revenue',  bottleneck: 'capex', depth: 2, parent: 'hyp_fcf', name: 'AI 기업 매출·이익 (OpenAI·Anthropic·xAI·Google)', lead: '12~18개월', weight: 3, level: 'easing', trend: 'improving',
    note: 'SemiAnalysis: NVIDIA 2H FY27 DC매출 컨센서스 +20% 상회 전망(HBM4 공급문제 해소). "美 DC 용량 절반 취소" 루머 반박 — capex 파이프라인 건재. 클라우드 AI 매출 구조 성장(GCloud +110%·Azure +84%·AWS +28%, Q1 2026), Micron Q3 FY26 $41.46B 실적 — ROI 실현 가시화 강화. MIT 95% ROI 미실현·프런티어 랩 적자는 잔존', src: 'SemiAnalysis 2026-06·ai-demand-sustainability.md·Micron IR' },
  ...
  { id: 'interconnect', bottleneck: 'power', depth: 1, name: '계통 접속 큐·지연일수', lead: '12~36개월', weight: 3, level: 'critical', trend: 'worsening',
    note: 'PJM 평균 8년 확정(2025 승인 기준)·선진국 허브 7~10년(최장 13년). 대기열 2,600GW·ERCOT 410GW(87% DC). PJM 용량권고 신메커니즘(06-24)·FERC 6개 RTO 대형부하 요금 개혁 명령(60일)·NERC Level 3 경보(8/3 기한, Computational Load Entity 등록 추진). DOE 2030년 100GW 신규 필요(50% DC). ERCOT 텍사스 145GW(2031)', src: '유틸리티·RTO 공시·IEA·WEF 2026·FERC·NERC' },
  ...
  { id: 'ai_alloc',  bottleneck: 'foundry', depth: 1, name: 'AI 배정 비율 (전통 수요와 캐파 경쟁)', lead: '3~9개월', weight: 2, level: 'easing', trend: 'stable',
    note: 'Counterpoint(06-30): 2026년 스마트폰 출하 -13.9% YoY(역대 최대 하락폭, 모바일 DRAM 가격 거의 3배 폭등이 원인)로 전통 수요 캐파 추가 여유 — 교차 부호: 수요 EWI엔 악재, 병목엔 완화. 단 NVIDIA 수요 재가속(node_ramp 참조)이 AI 배정분 자체는 다시 조이는 중', src: 'Counterpoint 2026-06-30' },
  ...
  { id: 'cowos_util',  bottleneck: 'packaging', depth: 1, name: 'CoWoS 가동률·증설', lead: '3~9개월', weight: 3, level: 'tight', trend: 'improving', ewiLink: 'cowos',
    note: 'TrendForce(06-15): CoWoS 수급 갭 2026년 말까지 20%→10%로 축소 전망. TSMC 2026말 130K WPM 목표 확정·CoPoS 파일럿 6월 완공·선진 패키징 매출 >10%(2025년 8%). 여전히 fully booked이나 완화 추세 가속', src: 'TSMC transcript·TrendForce 2026-06·GlobalSemiResearch' },
