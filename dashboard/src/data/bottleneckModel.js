...
export const MODEL_ASOF = '2026-06-23'
...
export const BOTTLENECKS = [
  {
    ...
    currentIndex: 73,
    indexNote: '미국 2026 계획 DC 캐파의 69% 미착공(16GW 발표·5GW만 착공, tech-insider 2026-06). 일부 지역 계통 접속 최대 10년 대기. 변압기·스위치기어 납기 18개월+ 초과. PJM 평균 8년 확정. DOE 연방 신속허가·FERC 개혁 논의. 텍사스·버지니아·조지아 허브 큐 연 단위 악화 지속',
  ...
  },
  {
    ...
    currentIndex: 40,
    indexNote: "Amazon $200B·Alphabet $175~185B·Meta $115~135B·Microsoft ~$190B(빅4 $725B·+77% 재확인). Micron Q3 FY26 $33.5B·81% GP(기록). 삼성 DS 이익 ~50배(Q1 2026). SK Hynix Q1 72% OP(기록). GCloud +63% YoY — ROI 실현 극대화. Meta FCF −90% 전망·ABS·SPV 의존 잔존 — 완화 하한 제약",
  ...
  },
  {
    ...
    currentIndex: 50,
    indexNote: 'TSMC N2 목표 140K WPM(2026말, 이전 130K에서 상향). NVIDIA Vera Rubin 풀 생산 확인(Jensen, 2026-06-01). Blackwell 70%+ 지배(GB300/B300·N3/N4P — 성숙노드 부담 분산). Rubin 출하 비중 29%→22%. AI 배정 여지 확대(스마트폰 약세). 대만 70% 집중·지정학 리스크 잔존',
  ...
  },
  {
    ...
    currentIndex: 63,
    indexNote: 'TrendForce 2026-06-15: CoWoS 수요-공급 갭 2026말 ~10%(현재 ~20%) 축소 전망. TSMC 목표 120~140K WPM. OSAT 합산 산업 총 캐파 ~200K WPM 근접. CoPoS 파일럿 6월 완공 확인. SK Hynix HBM4 속도 조절(DRAM 전환) → 수요 완화 기여. 선진 패키징 매출 >10%. 여전히 fully booked이나 점진 완화 추세 가속',
...
export const DRIVERS_ASOF = '2026-06-23'
...
export const BOTTLENECK_DRIVERS = [
  ...
  { id: 'capex_guide', bottleneck: 'capex', depth: 1, name: 'capex 가이던스·발주 모멘텀', lead: '1~3분기', weight: 3, level: 'easing', trend: 'stable', ewiLink: 'capex_guide',
    note: "Amazon $200B·Alphabet $175~185B·Meta $115~135B·Microsoft ~$190B(빅4 $725B·+77% 확인). GCloud +63% YoY·삼성 DS 이익 ~50배·SK Hynix Q1 72% OP·Micron Q3 FY26 $33.5B — ROI 실현 극대화. 발주 모멘텀 유지", src: '빅4 IR·Statista·Samsung·SK Hynix·Micron IR' },
  ...
  { id: 'interconnect', bottleneck: 'power', depth: 1, name: '계통 접속 큐·지연일수', lead: '12~36개월', weight: 3, level: 'critical', trend: 'worsening',
    note: '미국 2026 계획 DC 캐파 16GW 중 5GW만 착공(69% 지연·취소, tech-insider 2026-06). 일부 지역 최대 10년 대기. 텍사스·버지니아·조지아 허브 큐 연 단위. 변압기·스위치기어 납기 18개월+ 초과. DOE 연방 신속허가·FERC 개혁 논의 중. PJM 평균 8년 확정', src: '유틸리티·RTO 공시·IEA·tech-insider 2026-06' },
  ...
  { id: 'node_ramp', bottleneck: 'foundry', depth: 1, name: 'N2/18A 선단 램프 진척', lead: '6~12개월', weight: 3, level: 'easing', trend: 'improving',
    note: 'N2 2026말 목표 140K WPM(이전 130K에서 상향, Tom\'s Hardware 2026-06). NVIDIA Vera Rubin 풀 생산 확인(Jensen 2026-06-01). Blackwell GB300/B300 70%+ 지배(N3/N4P). N2 전량 예약(Apple 50%+)', src: 'tsmc.md·Tom\'s Hardware 2026-06·TechTimes 2026-06-02' },
  ...
  { id: 'cowos_util',  bottleneck: 'packaging', depth: 1, name: 'CoWoS 가동률·증설', lead: '3~9개월', weight: 3, level: 'tight', trend: 'improving', ewiLink: 'cowos',
    note: 'TrendForce 2026-06-15: CoWoS 수요-공급 갭 2026말 ~10%(현재 ~20%) 축소 전망. TSMC 목표 120~140K WPM(상향). OSAT 합산 산업 캐파 ~200K WPM 근접. SK Hynix HBM4 속도 조절(DRAM 전환) → 수요 완화 기여. CoPoS 파일럿 6월 완공 확인. 선진 패키징 매출 >10%. 점진 완화 추세 가속', src: 'TrendForce 2026-06-15·TSMC Symposium·SK Hynix IR' },
