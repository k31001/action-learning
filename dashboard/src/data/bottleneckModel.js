...
export const MODEL_ASOF = '2026-08-18'
...
export const BOTTLENECKS = [
  {
    ...
    currentIndex: 75,
    indexNote: '2026-08-18 갱신: 텍사스 주지사 지시로 ERCOT 신규 데이터센터 접속이 사실상 일시 동결(250~300개 프로젝트·약 200GW 감사 착수, 전체 큐 474GW·90% DC) — 큐 적체를 넘어 실제 처리가 멈춘 최초 사례. SemiAnalysis(08-16): PJM 용량경매 모델링 결함으로 $120억 낭비·재발 위험 지적. 지멘스에너지 그리드 백로그 사상최고 €510억. 변압기·개폐장치 리드타임 최대 5년 — 가스터빈(~3년)보다 강한 신규 병목. 요금이 아니라 접속 가능한 MW/GW의 실재적 한계',
  ...
  },
  {
    ...
    currentIndex: 39,
    indexNote: "2026-08-18 갱신: 이번 구간 신규 가이던스 없음(7월 실적 반영분 유지 — MS $190B·Alphabet $195~205B·Amazon $220B·Meta $130~145B). HY OAS 271bp 역사적 저점권(08-12)·AI 데이터센터 채권 프리미엄이 광의 HY 대비 거의 0으로 추가 압축 — 자금조달 긴장 추가 완화. SPV·부외부채 의존(~$120B)은 잔존",
  ...
  },
  {
    ...
    currentIndex: 50,
    indexNote: '2026-08-18 갱신: 이번 구간(08-11~08-18) TSMC·ASML 신규 뉴스 없음 — 07-04 수준(N2 램프 순항·High-NA 2029 연기·NVIDIA Rubin 22% 하향) 유지, 지수 불변. 참고: HBM4 원가 $31~32/GB(TrendForce 08-13)는 파운드리 캐파가 아닌 HBM 가격 정보. 대만 집중(0.525/0.75)·지정학 리스크 잔존',
  ...
  },
  {
    ...
    currentIndex: 65,
    indexNote: '2026-08-18 갱신: 삼성 HBM4 수율 마이크로범프 경로로 <60%→약 80% 개선(08-10). SK하이닉스가 HBM4 램프를 자발적으로 1개 분기 연기(HBM3E 잔존 수요 우선, 일부 캐파 DDR5 재배정, 08-13)·NVIDIA가 Rubin Ultra 메모리를 최대 1TB→최소 192GB까지 하향 검토(08-04/07) — 공급·수요 양측에서 단기 완화 신호 중첩. CoWoS WPM·CoPoS 자체 진척은 이번 구간 신규 뉴스 없음(07-04 수준 유지: NVIDIA 배정 ~60%·OSAT 24~27만 장·CoPoS 2028H2~2029)',
...
export const DRIVERS_ASOF = '2026-08-18'
...
export const BOTTLENECK_DRIVERS = [
  ...
  { id: 'financing',   bottleneck: 'capex', depth: 1, name: '외부 자금조달 (HY OAS·사모신용·ABS)', lead: '0~2분기', weight: 2, level: 'neutral', trend: 'improving', ewiLink: 'credit_spread',
    note: 'HY OAS 271bp 역사적 저점권(2026-08-12)·AI 데이터센터 채권 프리미엄이 광의 HY 대비 거의 0으로 압축 — 부채·SPV·ABS 의존 자체는 잔존하나 스프레드 확대 신호 없음', src: 'FRED·Convex(2026-08-12)·Penn Mutual(2026-08-06)' },
  ...
  { id: 'interconnect', bottleneck: 'power', depth: 1, name: '계통 접속 큐·지연일수', lead: '12~36개월', weight: 3, level: 'critical', trend: 'worsening',
    note: '2026-08-18 갱신: 텍사스 주지사 지시로 ERCOT 신규 DC 접속이 사실상 일시 동결(250~300개 프로젝트·약 200GW 감사, 전체 큐 474GW·90% DC) — 큐 적체를 넘어 실제 처리가 멈춘 최초 사례. SemiAnalysis(08-16): PJM 용량경매 모델링 결함으로 $120억 낭비·재발 위험. 지멘스에너지 백로그 사상최고 €510억', src: 'Texas Tribune·KERA News(2026-08-14/17)·SemiAnalysis(2026-08-16)' },
  ...
  { id: 'ai_alloc',  bottleneck: 'foundry', depth: 1, name: 'AI 배정 비율 (전통 수요와 캐파 경쟁)', lead: '3~9개월', weight: 2, level: 'easing', trend: 'improving',
    note: '2026-08-18 갱신: 스마트폰 출하 2Q26 -11%(13년 만 최저)·2026 전망 -2.1%→-14% 추가 하향 = AI 배정 여지 확대 — 교차 부호: 수요 EWI엔 악재(약세 심화), 병목엔 완화', src: 'Counterpoint(2026-08)' },
  ...
  { id: 'cowos_util',  bottleneck: 'packaging', depth: 1, name: 'CoWoS 가동률·증설', lead: '3~9개월', weight: 3, level: 'tight', trend: 'improving', ewiLink: 'cowos',
    note: 'NVIDIA 배정 ~60%(~59.5만 장) 확정·TSMC 2026년 24~27만 장 OSAT(Amkor·SPIL) 외주 확대로 공급 대응 진전. CEO 재확인: "매우 타이트, 2025~26 sold out 지속". 첨단패키징 2026 TSMC CAPEX 최대 20% 배정. 2026-08-18 갱신: SK하이닉스 HBM4 램프 자발적 연기(HBM3E 잔존 수요 우선)·NVIDIA Rubin Ultra 메모리 최대 1TB→최소 192GB 하향 검토 — 수요측 자율 조정으로 단기 수요압 일부 완화', src: 'TSMC transcript·Silicon Analysts 2026-07·TrendForce(2026-08-13)' },
  ...
  { id: 'stack_yield', bottleneck: 'packaging', depth: 2, parent: 'cowos_util', name: 'HBM 적층·테스트 수율 (TSV/KGD·16-Hi)', lead: '6~12개월', weight: 2, level: 'neutral', trend: 'improving',
    note: '삼성 하이브리드본딩 프로토타입 시험수율 ~10%에 그쳐 업계가 HBM4 마이크로범프 유지로 선회(하이브리드본딩 업계 전반 연기). 8Hi→12Hi 전환 수율 15~20%↓, 16-Hi는 더 큰 하락 예상 — CoPoS 전면 양산도 2028~29로 지연 재확인. 2026-08-18 갱신: 삼성 HBM4 수율(마이크로범프 경로) 2월 양산 개시 <60%→약 80%로 개선 확인 — 하이브리드본딩 정체는 잔존하나 대체 경로가 작동 중', src: 'SemiEngineering·TrendForce(2026-07·2026-08-10)', unknown: true },
