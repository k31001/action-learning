...
export const MODEL_ASOF = '2026-06-19'
...
export const BOTTLENECKS = [
  {
    ...
    currentIndex: 72,
    indexNote: '글로벌 DC 전력 2026년 약 1,050 TWh — IEA 2030 Base Case(945 TWh)를 4년 앞당겨 초과. Goldman: 2030년까지 165% 증가·122 GW. 미국 DC 전력 2026 75.8 GW → 2030 134.4 GW. AI DC 전력 연 15% 성장(전체 4배). PJM 평균 8년·DOE 100GW·ERCOT 145GW — 계통 접속 리드타임(7~13년)과 수요 격차 추가 확대',
  ...
  },
  {
    ...
    currentIndex: 40,
    indexNote: "Microsoft CY2026 CapEx $190B 확정 — 컨센서스 $154.6B 대비 +$35B 초과·2025 $118B 대비 +61%. 빅4 합산 $690~720B·전체 하이퍼스케일러 $800B+. Samsung HBM4 단가 $500~560·마진 >80%. AWS+28%·GCloud+110%·Azure+84%·Meta+54% AI 매출 가속. ROI 실현 강화로 CAPEX 경색 하방 리스크 추가 완화",
  ...
  },
  {
    ...
    currentIndex: 50,
    indexNote: 'Vera Rubin 풀 프로덕션 확정(2026-06-01)·3사 HBM4 공급사 확인(2026-06-05) → N3 캐파 정상 공급 운영 직접 증거. Counterpoint HBM4: SK 54%·Samsung 28%·Micron 18%. N2 램프 순항. 대만 집중(0.525/0.75)·지정학 리스크 잔존',
  ...
  },
  {
    ...
    currentIndex: 70,
    indexNote: 'TSMC CEO(2026-06-04) 직접 발언: "extremely tight, sold out through 2026". 3개 시설 2027까지 완판·납기 52~78주. NVIDIA 2026년 CoWoS 출력 60% 선점(800K~850K 웨이퍼). 2027 말 170K WPM 확장 목표. CoPoS 파일럿 완공·신규 사이트는 2028+',
    desc: 'TSMC CoWoS 2026말 125K~130K WPM → 2027 170K WPM 목표. CEO 확인: 2026~2027 병목 지속. 2028+ 신규 사이트(Amkor AZ·SK 인디애나·TSMC AZ) 완화 대기',
...
export const DRIVERS_ASOF = '2026-06-19'
...
export const BOTTLENECK_DRIVERS = [
  ...
  { id: 'capex_guide', bottleneck: 'capex', depth: 1, name: 'capex 가이던스·발주 모멘텀', lead: '1~3분기', weight: 3, level: 'easing', trend: 'stable', ewiLink: 'capex_guide',
    note: "Microsoft CY2026 $190B 확정(컨센서스 +$35B 초과·+61% YoY). 빅4 합산 $690~720B·전체 하이퍼스케일러 $800B+. Amazon $200B·Google $175~185B·Meta $125~145B. 메모리 가격 급등이 Microsoft CapEx 상향 주요 요인", src: '빅4 분기 콜·CNBC·The Register' },
  ...
  { id: 'ai_revenue',  bottleneck: 'capex', depth: 2, parent: 'hyp_fcf', name: 'AI 기업 매출·이익 (OpenAI·Anthropic·xAI·Google)', lead: '12~18개월', weight: 3, level: 'neutral', trend: 'stable',
    note: '클라우드 AI 매출 강세 지속(GCloud +110%·Azure +84%·AWS +28%). Samsung HBM4 마진 >80%·단가 $500~560 확인 — ROI 실현 강화. Micron $33.5B(역대최고)·HBM3E 완판 유지. 프런티어 랩 적자 잔존하나 하이퍼스케일러 수익성은 견고', src: 'ai-demand-sustainability.md·Samsung IR·Micron IR' },
  ...
  // ── 패키징 상류 ──
  { id: 'cowos_util',  bottleneck: 'packaging', depth: 1, name: 'CoWoS 가동률·증설', lead: '3~9개월', weight: 3, level: 'tight', trend: 'worsening', ewiLink: 'cowos',
    note: 'TSMC CEO(2026-06-04) 직접 발언: "extremely tight, sold out through 2026". 3개 첨단 패키징 시설 2027까지 완판·납기 52~78주. NVIDIA 60% 선점(800K~850K 웨이퍼/2026년). 2027 말 170K WPM 목표. 완화는 2028+ 신규 사이트 가동까지 대기', src: 'TSMC CEO 주주총회(2026-06-04)·fusionww.com·Silicon Analysts' },
