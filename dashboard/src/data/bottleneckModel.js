...
export const MODEL_ASOF = '2026-08-11'
...
export const BOTTLENECKS = [
  {
    ...
    currentIndex: 76,
    indexNote: '텍사스 주지사 전주(全州) 신규 DC 그리드 접속 일시중단(08-03, 감사 완료까지 무기한 — BNEF 49.8GW 지연·최대 $150억 비용 경고). ERCOT 대형부하 큐 410GW→474GW(4개월). GE Vernova 가스터빈 백로그 100→116GW(2030년까지 매진). PJM 용량경매 사상 최고가 $333.44/MW-day, 예비율 18.9%→14.8%. FERC 개혁(60일 시한 08-17 마감)은 유일한 완화 레버이나 미확정',
  ...
  },
  {
    ...
    currentIndex: 38,
    indexNote: '빅4 Q2 실적 후 전원 상향(합산 ~$745~750B·+82% YoY, 삭감 0건)·Micron FQ3 사상 최고 가이던스. 단 Meta FCF -91%·Amazon TTM FCF 마이너스 전환이 처음 실측 등장(자금조달이 부채·SPV 쪽으로 이동하는 후기순환 신호) — 완화 폭을 이전 추세보다 축소',
  ...
  },
  {
    ...
    currentIndex: 55,
    indexNote: '3개 분기 연속 완화 추세 반전 — TSMC 7월 매출 사상 최고(+44.7% YoY)·2분기 CAPEX $60~64B로 상향·N2/A16 리드타임 78~156주로 2027~28년까지 예약 완료, N3 신규 수주 일부 중단 보도. ASML 2027~28년 캐파 +30%씩 증설은 장기 완화 요인이나 근시일 효과 없음',
  ...
  },
  {
    ...
    currentIndex: 68,
    indexNote: '완화 추세 정체·소폭 반전 — TSMC CoWoS "완전 가동" 확인·리드타임 52~78주 지속, ABF 기판 재차 타이트(Ajinomoto 3분기 가격 +30%). 삼성 HBM4 수율 ~80% 조기 달성은 완화 요인이나 공급능력 확대라기보다 공급사간 재분배. NVIDIA·AMD가 Rubin Ultra HBM 구성 12-Hi→8-Hi 하향 검토 — 수요측이 공급제약에 순응 시작',
