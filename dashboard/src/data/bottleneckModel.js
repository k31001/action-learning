...
export const MODEL_ASOF = '2026-07-28'
...
export const BOTTLENECKS = [
  {
    ...
    currentIndex: 75,
    indexNote: 'PJM 용량경매 FERC 상한 도달·2년 연속 예비력 미달로 6.8GW 부족 확정(프로젝션→실현). 2027-06부터 50MW+ DC 강제감축 규정 FERC 제출 예정. ERCOT 큐 410→438GW(10주 +7%). 변압기 리드타임 최대 5년→일부 라인 2031년 납품. Meta RE100 탈퇴+가스발전 5.2GW 확대. 요금이 아니라 접속 가능한 MW/GW의 실재적 한계',
  ...
  },
  {
    ...
    currentIndex: 44,
    indexNote: "TSMC·Micron 가이던스 재상향·Dell'Oro $1조 돌파·JPMorgan $5.5조 재확인(완화)이나, Oracle 신용등급 BBB→BBB- 하향(AI CAPEX 노출 첫 등급조치)·하이퍼스케일러 회사채 주문 커버리지 5배→2배 미만·부외부채 재평가($120B→최대 $1.65조)로 신용 잠재 리스크 신규 부상. HY OAS는 269~277bp로 안정",
  ...
  },
  {
    ...
    currentIndex: 54,
    indexNote: "TSMC 2026 CAPEX 가이던스 $52~56B→$60~64B 대폭 상향·ASML High-NA 2029 연기 재확인. 신규 — 삼성 파운드리 브로드컴 ~$200B 수주+Anthropic 2nm MOU+Tesla AI6로 대만 집중 리스크의 실질적 분산 시작(유효 캐파 총량 증가). N3도 완판 등 수요 강세는 잔존",
  ...
  },
  {
    ...
    currentIndex: 64,
    indexNote: '캐파 4배 확장 중(2026말 목표 ~13만 wpm)이나 수요가 계속 상회(2026말까지 완판 유지). HBM4 하이브리드본딩이 열/냉각 이슈로 추가 지연, JEDEC이 HBM4E 세대까지 핀피치 완화 검토(마이크로범프 의존 한 세대 더 연장 조짐). "패키징이 진짜 병목"이라는 업계 프레이밍 확산(TechTimes 2026-07-28)',
