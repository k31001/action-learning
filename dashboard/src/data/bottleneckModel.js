...
export const MODEL_ASOF = '2026-08-25'
...
export const BOTTLENECKS = [
  {
    ...
    currentIndex: 75,
    indexNote: 'ERCOT 2026 Q1 신규 접속신청 198GW 폭주 vs 지난 12개월 실제 승인 9,062MW뿐 — 승인률 극도 저조가 처음 정량 확인. 변압기 리드타임 최대 128주·GSU 144주·일부 4년, 개폐장치 60주 초과(2025년말 44주에서 추가 상승). 원자력 커밋 9.8GW 중 가동은 1.92GW뿐(실질 완화 2027년 하반기 이후). 요금이 아니라 접속 가능한 MW/GW의 실재적 한계 — 5개 분기 연속 유일한 악화 축',
  ...
  },
  {
    ...
    currentIndex: 38,
    indexNote: "빅4 합산 $725B로 추가 상향(Amazon $220B·Google $195~205B·Meta 하한 $130~145B). Dell'Oro 2030 $1.7조·JPMorgan 2030 누적 $5.5조 재확인. HY OAS 275bp 역사적 최저. 단 Alphabet 상장후 첫 FCF 마이너스·Meta 실적 익일 주가 -10% — ROI 실현 지연에 대한 투자자 인내심 약화가 신규 하위 리스크",
  ...
  },
  {
    ...
    currentIndex: 49,
    indexNote: 'TSMC N2 2Q26 웨이퍼매출 첫 유의미 기여(3%)·2026 CapEx $60~64B로 상향, CFO "3개년 CapEx 과거比 significantly higher". ASML 메모리向 매출 +75% 가이던스(로직 +25%), High-NA는 여전히 2029년 연기. 단 HPC(AI) 매출비중 66%로 캐파 대비 AI 수요압력도 동반 상승 — 완화 속도 정체. 대만 집중(0.525/0.75)·지정학 리스크 잔존',
  ...
  },
  {
    ...
    currentIndex: 64,
    indexNote: 'TrendForce: CoWoS 수급 갭 20%→10%로 연내 축소, 캐파 연말 120~130K wpm+OSAT 오버플로우 ~80K wpm. 삼성 HBM 웨이퍼 캐파 17만→25만 wpm(+47%, 연말 목표)·HBM4 수율 60%→80%. NVIDIA Rubin 2026년 출하 20~30만대 그치고 물량 대부분 2027 이월 — 2026년 압력 완화. 단 CoWoS 14-reticle 양산 2028년·하이브리드본딩 정체(마이크로범프 유지)는 구조적 상한으로 잔존',
...
export const DRIVERS_ASOF = '2026-08-25'
...
export const BOTTLENECK_DRIVERS = [
  ...
  { id: 'capex_guide', bottleneck: 'capex', depth: 1, name: 'capex 가이던스·발주 모멘텀', lead: '1~3분기', weight: 3, level: 'easing', trend: 'improving', ewiLink: 'capex_guide',
    note: "빅4 합산 $725B로 추가 상향(Amazon $220B·Google $195~205B·Meta 하한 $130~145B). Dell'Oro 2030 $1.7조·JPMorgan 2030 누적 $5.5조 재확인. 단 Alphabet 상장후 첫 FCF 마이너스·Meta 실적 익일 주가 -10% — 지출액과 별개로 ROI 인내심 약화 조짐, 하위 리스크로 병기", src: '빅4 2Q26 실적콜·Dell\'Oro·JPMorgan(2026-07/08)' },
  ...
  { id: 'interconnect', bottleneck: 'power', depth: 1, name: '계통 접속 큐·지연일수', lead: '12~36개월', weight: 3, level: 'critical', trend: 'worsening',
    note: 'ERCOT 2026 Q1 신규 접속신청 198GW(심사대기 86GW=ERCOT 피크부하 규모) vs 지난 12개월 실제 승인 9,062MW뿐 — 승인률 극도 저조 신규 확인. PJM 2030년까지 최대 15GW 구조적 부족 경고 재확인. PJM Expedited Track 8월 시행 예정(BYONG 활용시 GIA 10개월)이나 시행 초기', src: 'ERCOT·PJM 2026-07/08, bottleneck-model-update-2026-08-25.md' },
  ...
  { id: 'transformer',  bottleneck: 'power', depth: 2, parent: 'interconnect', name: '변압기·HV 케이블 리드타임', lead: '18~36개월', weight: 2, level: 'critical', trend: 'worsening',
    note: '대용량 변압기 128주·발전기 승압용 GSU 144주·일부 특수사양 최대 4년(2020-21년 약 1년 대비)으로 추가 연장. 개폐장치·고압차단기 60주 초과(2025년말 44주에서 상승). GOES 강판 미국 내 생산업체 단 1곳. 계획 DC의 절반 가까이 지연·취소 위험', src: 'PowerMag·TerrapinCG 2026-05~07' },
  ...
  { id: 'node_ramp', bottleneck: 'foundry', depth: 1, name: 'N2/18A 선단 램프 진척', lead: '6~12개월', weight: 3, level: 'easing', trend: 'improving',
    note: 'TSMC 2Q26 N2 웨이퍼매출 첫 유의미 기여(3%), 2026 CapEx $60~64B로 상향. CFO "3개년 CapEx 과거比 significantly higher" — 램프는 순항하나 HPC 매출비중 66%로 AI向 수요압력도 동반 확대', src: 'TSMC 2Q26 실적콜(2026-07-16)' },
  ...
  { id: 'cowos_util',  bottleneck: 'packaging', depth: 1, name: 'CoWoS 가동률·증설', lead: '3~9개월', weight: 3, level: 'neutral', trend: 'improving', ewiLink: 'cowos',
    note: 'TrendForce: CoWoS 수급 갭 20%→10%로 연내 축소. 캐파 연말 120~130K wpm+OSAT(Amkor·ASE) 오버플로우 ~80K wpm. NVIDIA 배정 ~60%(~59.5만 장) 유지되나 총량 확대로 압박 완화. 첨단패키징 2026 TSMC CAPEX 최대 20% 배정', src: 'TrendForce(2026-06-15)·TSMC 2Q26 실적콜' },
  ...
  { id: 'stack_yield', bottleneck: 'packaging', depth: 2, parent: 'cowos_util', name: 'HBM 적층·테스트 수율 (TSV/KGD·16-Hi)', lead: '6~12개월', weight: 2, level: 'neutral', trend: 'improving',
    note: '삼성 HBM4 수율 2월 양산개시 60% 미만 → 2026-08-10 기준 80%로 상승(TrendForce, 연말 목표 조기 달성). 단 하이브리드본딩 시험수율은 여전히 ~10% 정체 — 마이크로범프 유지 기조 불변(HBM4E·2027년 이후로 순연), CoPoS 전면 양산도 2028~29 재확인', src: 'TrendForce(2026-08-10)', unknown: true },
