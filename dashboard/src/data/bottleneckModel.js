...
export const MODEL_ASOF = '2026-08-04'
...
export const BOTTLENECKS = [
  {
    ...
    currentIndex: 75,
    indexNote: 'PJM 2028/29 용량경매 14.4% 예비율로 목표(20%) 미달 — 이사회가 백스톱 경매+DC 우선감축안 제안(신뢰성 목표 미달 공식화 최초 신호). ERCOT 대기열 410GW+에 신규 ~140GW 추가(총 ~380GW 육박). 변압기 리드타임 최대 5년→60개월로 재악화, 개폐장치 44주→60주+. 원자력 커밋 9.8GW+이나 가동은 2028년 이후 — 단기 완화 제한적',
  ...
  },
  {
    ...
    currentIndex: 37,
    indexNote: "빅4(Alphabet·MSFT·Meta·Amazon) 2026 CapEx 가이던스 전원 상향/재확인(합산 ~$730~760B) — 둔화 신호 0건. Amazon +$20B·Microsoft(직전분기) +$25B을 메모리 원가에 명시 귀속(2개 분기 연속). Meta FCF $784M로 급감(잔존 리스크). HY OAS 안정 기준 유지",
  ...
  },
  {
    ...
    currentIndex: 49,
    indexNote: 'TSMC CY2026 매출성장 가이던스 40%+ 상향·CapEx $60~64B 상향(+애리조나 추가 $100B)·N2 2026 H2 본격 램프 궤도 확인(재고일수 76.5일). 단 40%+ 성장은 공급 확장보다 여전히 빠른 수요 증가 시사. 대만 집중(0.525/0.75)·지정학 리스크 잔존',
  ...
  },
  {
    ...
    currentIndex: 69,
    indexNote: 'CoWoS 130K WPM(2026말) 궤도 유지(완화 방향)이나 HBM4 하이브리드본딩 추가 후퇴 — 16-hi HBM4E가 현실적 최초 채택 시점으로 밀림(SK하이닉스 수율 미성숙 공식 확인). CoPoS 전면 양산 2028년 하반기~2029년 재확인. 완화 대세는 유지하되 기술 지연 리스크 재부상',
