...
export const DT_PHASES = [
  {
    ...
    theme: '증명',
    color: '#1428a0',
    actions: ['파일럿 고객 1사 Co-Design Pod 1호 발족', '워크로드 랩 최소 구성 + 시스템 모델 v0.1 (디바이스→서버 레벨, 실측 오차 검증)', '선제 제안 1호 — 파일럿 고객 차세대 로드맵 대상', 'KPI 개정안 설계 (제안·공동설계 지표 추가)'],
  },
  {
    phase: 'Phase 2 · 1년',
    theme: '제도화',
    color: '#d97706',
    actions: ['Co-Design Pod 3~5개 확대 (모델사+하이퍼스케일러+ASIC)', '시스템 아키텍트·모델링 전문 조직 신설 — 모델 v1.0 (랙 레벨)', '로드맵 교차 리뷰 정례화 (분기)', 'PoA 사이클 제도화 — 연 4회', '개정 KPI 전면 적용', '★ SCA형 계약 1건 이상 수주 (공동설계 조항 포함)'],
  },
  {
    phase: 'Phase 3 · 3년',
    theme: '표준화',
