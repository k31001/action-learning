...
export const INITIAL_INDICATORS = [
  ...
  },
  {
    ...
    note: '실측 GPU 현물 임대가(Tier0 최선행). H100 SXM·H200 0.5:0.5 바스켓으로 유동성 안정화. 매일 자동 누적되어 추세 형성. 23년 ~$8 → 25~26년 $2~4. 2026-09 firming/flat(H100 ~$2.65~2.89·H200 +20~40%·메모리 병목).',
    inputType: 'number',
...
export const INITIAL_TRIGGERS = [
  ...
  },
  {
    ...
    activated: false,
    activatedDate: null,
    note: '[2026-09-15] 미발동 — 9월 미중 정상회담이 실제 개최 국면(무역·AI·수출통제·타이완 의제, 칩 장비 파일이 가장 절차 진전). 범용 DRAM/NAND 수출 공식 재개 합의·포괄 라이선스 등 실현된 타결은 미확정 → 미발동. 정상회담이 완화로 귀결되면 이 트리거(공존 강화·DF2 하향) 발동 방향, 결렬·MATCH 진전 시 match_act_passed(디커플링) 방향. DF2 최상위 양방향 분기점으로 결과 대기',
    isPositive: true,
