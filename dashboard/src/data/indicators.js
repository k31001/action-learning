...
export const INITIAL_INDICATORS = [
  ...
  },
  {
    ...
    history: [
      ...
      { date: '2026-08-25', value: 37, note: '[08-25 웹 리서치] 값 미변경(교차 상충으로 보수적 유지) — Q2 2026 저품질 2차 집계 사이트 인용치는 SK하이닉스 62%·Micron 21%·삼성 17%로 대폭 하회 보도(원출처 Counterpoint 직접 확인 실패, egress 차단). 동시에 삼성 HBM4 수율 60%→80%(TrendForce 08-10)·HBM 웨이퍼 캐파 +47%(연말 25만wpm 목표)·3Q26 HBM4 매출 전분기 3배 가이던스 등 개선 신호도 병존, UBS(07-31)는 "삼성이 2027년 HBM 왕좌 탈환 가능" 전망. 상충 데이터라 currentValue 미변경, 다음 정기 점검에서 Counterpoint 원출처 재확인 필요' },
    ],
    note: '2026Q1 37%(SK 51%·Micron 12%, TrendForce/hbm-share.json 기준). 4월 35~40% 급회복. 교차: Counterpoint Q1 확정치는 삼성 ~32%·SK ~58%로 더 낮음 — 시점·집계 기준 차이(시계열은 hbm-share.json 기준 통일). Counterpoint도 삼성 2026 연간 30%+ 전망 (july-2026-market-update). [08-25] Q2 2026 데이터 상충(SK 62%·삼성 17% 저품질 출처 vs 수율·캐파 개선 신호) — 재확인 대기, 상세는 wiki/concepts/hbm-market.md',
    inputType: 'number',
  ...
  },
  {
    ...
    history: [
      ...
      { date: '2026-Q2', value: 7, note: 'Counterpoint(발표 2026-08-04/05) 매출 기준 DRAM 점유율 7% — 4위권 부상 재확인(삼성 39%·SK 26%·Micron 25%에 이어). 기존 추정(8%)과 근접, 매출 계열 첫 정식 확정치' },
    ...
    note: '캐파: 2024년 17만 WSPM → 2026E 30만 WSPM (글로벌 10~12%). FT(2026-07-08) 캐파 점유 11%(2025)→15%(2028E) — 매출 점유(본 EWI)와 별개 계열. 빅펀드 III $470억 + 안후이성 정부 지원. DDR5 양산 + DDR5-8000·LPDDR5X-10667 시연. 애플이 中 내수용 기기에 CXMT DRAM 테스트 착수(FT 2026-07-08)로 프리미엄 고객 인증 파이프라인 진입 — cxmt_apple_qualification EWI 연동. [08-25] Counterpoint Q2 2026 매출 점유 7% 확정 — 캐파 점유(FT 계열)와 별개로 매출 계열도 4강 지위 유지 확인, wiki/concepts/dram-market-share.md',
    inputType: 'number',
...
export const INITIAL_TRIGGERS = [
  ...
  },
  {
    ...
    activated: false,
    activatedDate: null,
    note: '[2026-08-25] 미발동 — H.R.8170 04-22 위원회 보고 후 본회의 표결 movement 없음(congress.gov, 08-25 확인). DF2 방향 결정 주 분기점으로 계속 추적. [2026-07-28] 미발동 — H.R.8170 위원회 통과 단계 유지, 07-21~28 창 내 본회의 표결 movement 없음(congress.gov). DF2 방향 결정 주 분기점으로 계속 추적',
