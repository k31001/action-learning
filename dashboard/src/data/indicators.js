...
export const INITIAL_INDICATORS = [
  ...
  },
  {
    ...
    category: 'quarterly',
    source: 'Counterpoint·TrendForce·Digitimes',
    unit: '%',
    unitLabel: '%',
    currentValue: 14,
    alertThreshold: 15,
    alertCondition: 'gte',
    alertDescription: '15%+ 시 빗 점유 상단 고착·범용 가격 압박 본격화. Q2 2026 이미 출하 3위(Kioxia 제침) — 이제 핵심은 매출 순위(현 5위)의 3위 수렴 여부와 DC eSSD 인증 돌파',
    scenarioSignals: ['D'],
    scenarioText: 'YMTC 빗 20% 진입 시 시나리오 D 다운턴 증폭기. 3공장 가동(2026 말~) + DRAM 50% 전환 검토 시 양면 위협 — 대응: wiki/strategies/ymtc-nand-defense.md',
    warningThreshold: 14,
    status: 'warning',
    ...
    history: [
      ...
      { date: '2025E', value: 15, note: 'YMTC 자체 목표 (미달 — Q2 2026 14%)' },
      { date: '2026-Q2', value: 14, note: 'Counterpoint — Kioxia 제치고 사상 첫 출하 3위 (삼성 25%·SK 22%). 단 매출 기준 5위 (컨슈머 편중 믹스)' },
    ],
    note: '294L 출하·Xtacking 5.0 개발 + 상하이 STAR IPO 330억 위안(생산 208억+R&D 122억) + FT발 "2027년 말 1위" 목표 + 캐파 설계 상한 50만 WSPM·3공장 국산장비 50% 돌파 — sources/articles/ymtc-nand-top3-ipo-2027-target-2026-08-28.md',
    inputType: 'number',
