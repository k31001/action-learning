...
export const INITIAL_INDICATORS = [
  ...
  },
  {
    ...
    history: [
      { date: '2026-05-05', value: 70, note: '보고서 기준 초기값' },
      { date: '2026-08-11', value: 80, note: '외부 보도 기준("golden yield", TrendForce·BigGo Finance) — 2월 양산 개시 <60%에서 4개월 조기 목표 달성, HBM4E 수율도 70%+ 돌파. 내부 KPI 공식 공시 아닌 외부 추정치로 표기 (august-2026-market-update-2026-08-11.md)' },
    ],
    note: '2026년 9월 30일까지 90%+ 목표. [08-11] 외부 보도 기준 80% 도달 — 공식 확인 시 내부 KPI로 교체 예정',
    inputType: 'number',
  ...
  },
  {
    ...
    history: [
      ...
      { date: '2026-Q2', value: 'Samsung', note: 'Counterpoint 2Q26 DRAM 매출 점유율: 삼성 39%(1위 재탈환)·SK하이닉스 26%·Micron 25%. SK하이닉스는 YoY 매출 +214%에도 점유율 하락(1년 전 39%) — HBM 평균판가 하락(legacy HBM3E 가격인하+HBM4 지연)이 배경 (august-2026-market-update-2026-08-11.md)' },
    ],
    note: '2025년 SK 매출 $496억 vs 삼성 $464억 — 연간 기준도 SK 우위였으나 2026 Q2 삼성이 매출 점유율 1위 재탈환(39% vs 26%, 13%p 격차). 회복은 HBM 점유율 회복이 선행 조건이었고, 삼성 HBM4 수율 80% 도약이 후속 근거',
    inputType: 'select',
    selectOptions: [
