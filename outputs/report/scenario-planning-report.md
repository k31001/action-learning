...
**작성일**: 2026년 5월 6일 (Q1 2026 실적 + 벤치마크 통합 업데이트) | **최종 데이터 갱신**: 2026년 8월 4일 (빅4 Q2 실적 전원 확정·병목 모델 4대 지수 갱신)
...
| **빅4 Q2 2026 실적 전원 확정 (2026-08-04)** | Alphabet $195~205B·Microsoft 회계상 ~$175B(실질 불변, FY27 상향)·Meta $130~145B(재상향)·Amazon ~$220B(+$20B). **합산 ~$730~760B, 둔화 신호 0건** | **Amazon +$20B을 메모리 가격 상승에 명시 귀속**(직전분기 Microsoft $25B에 이어 2개 분기 연속) — 메모리→CapEx 되먹임 재확인 |
...
| **4대 병목 제약지수 (2026-08-04, 이전 07-04 대비)** | 전력 **75**(▲+3) · CAPEX **37**(▼-3, 최대 완화 폭) · 파운드리 **49**(▼-1) · 패키징 **69**(▲+2) | 전력 3개 분기 연속 재상승(PJM 용량경매 목표 미달 공식화·변압기 60개월). CAPEX는 빅4 전원 상향으로 최대 폭 완화, 패키징은 하이브리드본딩 지연으로 반전(완화→긴장) |
...
> 최신 데이터 출처: [sources/articles/august-2026-market-update-2026-08-04.md](../../sources/articles/august-2026-market-update-2026-08-04.md) (SemiAnalysis·Counterpoint·TechInsights·빅4 Q2 실적 등), 이전: [sources/articles/july-2026-market-update-2026-07-04.md](../../sources/articles/july-2026-market-update-2026-07-04.md)
...
| 병목 | 현재 지수 (2026-08-04, 07-04 대비 변동) | 핵심 감시 트리거 | 충격 시 영향 (연환산) |
|---|---|---|---|
| 전력 | **75 Red**(▲+3) — PJM 용량경매 목표 미달 공식화·변압기 60개월 | 상위 허브 2+ reserve <8% · LMP P90 72h · 접속지연 >60일 | HBM -0.61EB (-21.1%) |
| 첨단 패키징 (CoWoS) | **69 Orange**(▲+2) — CoWoS 캐파 확대는 궤도, 하이브리드본딩 추가 지연 | qualified output -15% WoW 2주 · 대형 사이트 outage | HBM -0.59EB (-20.5%) |
| 선단 파운드리 | 49 Yellow(▼-1) — N2·CapEx 상향, 40%+ 성장 가이던스 | N2/A16 램프 1분기+ 지연 · High-NA 삽입 지연 | HBM -0.43EB (-14.9%) |
| CAPEX/ROI | 37 Yellow(▼-3, 최대 완화 폭) — 빅4 Q2 전원 CapEx 상향/재확인 | capex 가이드 -15% · FCF/CapEx <0.8 · HY OAS 급등 | **HBM -0.91EB (-31.5%)** |

운영 원칙: 전력은 실시간 API(EIA·PJM·ERCOT) 감시가 가능한 유일한 축, 나머지는 공시·IR 이벤트 기반(단일 공식 원문도 Red 승격 가능). 복합 충격(전력 Red + CAPEX Orange 동시 1개월)은 HBM -38~-47%로 비상대책위 발동 사유. 충격별 즉시/중기/사전 대응 매뉴얼은 대시보드 탭에 내장. 전력이 07-04 이후 3개 분기 연속 상승해 4대 병목 중 유일하게 Red 밴드로 진입했다.
