...
**병목 레이더 (2026-06-22 업데이트 — 대시보드 Bottleneck Model 탭)**
...
| 병목 | 현재 지수 (2026-06-22) | 전회 대비 | 핵심 감시 트리거 | 충격 시 영향 (연환산) |
|---|---|---|---|---|
| 전력 | **72 Orange** ↑ — MS $80B Azure 백로그 전력 제약 | ▲ **+2** | 상위 허브 2+ reserve <8% · LMP P90 72h · 접속지연 >60일 | HBM -0.61EB (-21.1%) |
| 첨단 패키징 (CoWoS) | **65 Orange** — CoWoS 갭 20%→10% 완화 진행 | ▼ **−3** | qualified output -15% WoW 2주 · 대형 사이트 outage | HBM -0.59EB (-20.5%) |
| 선단 파운드리 | **50 Yellow** — N2 멀티팹·A13/N2U 로드맵 | ▼ **−2** | N2/A16 램프 1분기+ 지연 · High-NA 삽입 지연 | HBM -0.43EB (-14.9%) |
| CAPEX/ROI | **40 Yellow** — DRAM Q1 $97B·$782B 강세 | ▼ **−2** | capex 가이드 -15% · FCF/CapEx <0.8 · HY OAS 급등 | **HBM -0.91EB (-31.5%)** |

**2026-06-22 주요 변화**: ① 전력이 3회 연속 상향 — MS가 $80B Azure 수주 잔고를 전력 부족으로 이행 불가 공개("GPU 재고, 전기 없어 설치 못함"). DC 전력 2026년 1,000 TWh 초과. 변압기 리드타임 128주(2.5년). ② 패키징 최대 완화폭 — TrendForce 2026-06-15: CoWoS 공급-수요 갭 20%→10%(2026년 말) 최초 공식 수치화. ③ TSMC Tech Symposium: A13·A12·N2U 신규 노드·N2 멀티팹 가속·tape-out 70개+. ④ CAPEX 지출 의지와 전력 물리 제약의 **분리 현상** 가장 강하게 표출(CAPEX↑↑ ≠ 배치 가능한 용량↑↑).
