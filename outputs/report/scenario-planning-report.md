...
**작성일**: 2026년 5월 6일 (Q1 2026 실적 + 벤치마크 통합 업데이트) | **최종 데이터 갱신**: 2026년 7월 21일 (병목 모델 지수 갱신 — 전력 3개 분기 연속 재상승·PJM 용량경매 미달 확정·TSMC/ASML Q2 서프라이즈)
...
### 핵심 수치 한눈에 (2026년 7월 21일 최신)

| 항목 | 수치 | 시사점 |
|------|------|---------|
| **Samsung Q2 2026 잠정실적 (2026-07-07)** | **매출 ~171조 원, 영업이익 ~89.4조 원(+1,181% YoY, 사상 최대)** | 컨센서스 상회하나 주가 6~10% 하락(밸류에이션·센티먼트 조정, 펀더멘털 아님). DS부문 세부는 07-30 확정 발표 |
...
| **4대 병목 제약지수 (2026-07-21, 이전 07-04 대비)** | 전력 **75**(▲+3) · CAPEX **40**(보합) · 파운드리 **48**(▼-2) · 패키징 **65**(▼-2) | 전력 3개 분기 연속 재상승 — PJM 용량경매 3년 연속 미달(전망→실측 확정)·폭염 비상. CAPEX는 실적시즌(07-22~30) 대기 보합. 파운드리·패키징 TSMC/ASML 서프라이즈로 완화 지속 |
...
> 최신 데이터 출처: [sources/articles/july-2026-market-update-2026-07-21.md](../../sources/articles/july-2026-market-update-2026-07-21.md), [sources/articles/july-2026-market-update-2026-07-04.md](../../sources/articles/july-2026-market-update-2026-07-04.md) (SemiAnalysis·Counterpoint·TechInsights 등)
...
#### 2.2.3 [정기점검] 2026-07-21 시장 업데이트 — 전력 병목 실측 확정·삼성 Q2 사상 최대·CXMT 상장

SemiAnalysis·Counterpoint·TechInsights 우선 참조 + PJM·TSMC·ASML·CXMT·Reuters·FT·한국 언론 보강 정기 점검(2026-07-21, 이전 점검 2026-07-04 대비).

- **병목 모델 4대 제약지수 갱신**: 전력 72→**75**(▲+3, PJM 2028/29 용량경매 목표 대비 6,831MW 부족 확정 — 이전까지 "전망"이던 부족이 처음으로 실제 경매 결과로 확정, 폭염 비상·예비마진 14.4%·전기설비 부족에 따른 CAPEX 30~50% 지연 리스크 신규 정량화), CAPEX/ROI 40→**40**(보합, 빅테크 4사 실적 콜이 07-22~30 예정이라 이번 창구엔 재확인 신호뿐), 파운드리 50→**48**(▼-2, TSMC Q2 콜에서 FY26 성장률 40%대 상회로 상향·CAPEX $60~64B 상향, ASML Q2 가이던스 상향), 패키징 67→**65**(▼-2, CoWoS 공급-수요 갭 20%→10% 축소 전망 재확인·Amkor CAPEX 상향, 단 HBM4 마이크로범프 유지는 불변). 상세: [wiki/concepts/bottleneck-model-2030.md §종합 판독(2026-07-21)](../../wiki/concepts/bottleneck-model-2030.md).
- **삼성 Q2 2026 잠정실적**: 매출 ~171조 원·영업이익 ~89.4조 원(+1,181% YoY, 사상 최대)로 컨센서스 상회. 발표 당일 주가 6~10% 하락 — Micron·SK하이닉스 등 메모리/AI 인접주 전반의 20%+ 밸류에이션 조정(07-02~07-19)과 동반된 센티먼트 신호로, 실적·수요 펀더멘털 악화가 아니므로 병목 지수·DF1 축에는 반영하지 않음. DS부문 세부·HBM 코멘터리 포함 확정 실적은 2026-07-30 예정.
- **SK하이닉스**: Q2 실적 발표 2026-07-29 예정(컨센서스 영업이익 ~63.45조 원). 발표 전 주가 +14% 랠리 후 섹터 조정에 동반 편입.
- **DRAM/NAND 가격 — 공식 vs 스팟 괴리**: TrendForce 공식 Q3 전망(+13~18%/+10~15% QoQ) 불변이나, ADATA는 스팟가 기준 DRAM +20~30%·NAND +35~40%로 더 가파르다고 보고 — 계약가 감속이 수요 둔화가 아닌 대형 바이어 협상력 반영일 가능성.
- **CXMT 상하이 STAR Market IPO**: 2026-07-16 상장, 약 $4.1~4.3B 조달(2026년 中 A주 최대 IPO). BIS Entity List 등재는 미중 무역협상과 연계해 보류된 반면, 하원 Moolenaar·Whitesides 의원은 등재+구매금지를 촉구하는 서한 발송 — 공존·디커플링 신호가 상쇄되며 DF2 리트머스는 여전히 미해결.
- **한국 — 별도 반독점 트랙(신규)**: 서울중앙지검이 삼성·SK하이닉스에 메모리 인터페이스 칩(MIC)을 공급하는 Montage·Renesas·Rambus 한국 사무소를 압수수색(2026-07-15) — 美 DRAM 가격담합 소송(삼성이 피고)과 반대로 삼성·SK는 이번 트랙에서 구매자 측. [dram-antitrust-litigation.md](../../wiki/concepts/dram-antitrust-litigation.md)에 별도 트랙으로 반영.
- **한국 정책**: 삼성 용인 국가산단 완공 목표 2040년(-7년)·SK하이닉스 용인 일반산단 2035년(-12년)으로 단축(2026-06-29 발표). 2026-07-13 반도체·AI 1,350조 원 지원 패키지(18.1조 원+ 신규 금융지원 프로그램 7월 출범) 발표.
- **DF1/DF2 거시 축**: 이번 창구의 신규 신호(전력 실측 악화, TSMC/ASML 서프라이즈, CXMT 상장, BIS 보류-의회반발 상쇄, 메모리주 밸류에이션 조정)는 모두 병목·개별기업 실행·센티먼트 영역이며 거시 축을 이동시키는 근거가 아니다. DF1 8.5·DF2 0.5·시나리오 확률(A26/B39/C8/D21/E6)은 직전 재평가를 유지.

> 1차 자료: [sources/articles/july-2026-market-update-2026-07-21.md](../../sources/articles/july-2026-market-update-2026-07-21.md)
...
**병목 레이더 (2026-06-10 신설, 2026-07-21 최신 — 대시보드 Bottleneck Model 탭)**
...
| 병목 | 현재 지수 (2026-07-21, 이전 07-04 대비) | 핵심 감시 트리거 | 충격 시 영향 (연환산) |
|---|---|---|---|
| 전력 | **75 Red**(▲+3) — PJM 용량경매 3년 연속 미달 확정·폭염 비상 | 상위 허브 2+ reserve <8% · LMP P90 72h · 접속지연 >60일 | HBM -0.61EB (-21.1%) |
| 첨단 패키징 (CoWoS) | **65 Orange**(▼-2) — sold-out 유지, 공급갭 20%→10% 축소 전망 | qualified output -15% WoW 2주 · 대형 사이트 outage | HBM -0.59EB (-20.5%) |
| 선단 파운드리 | **48 Yellow**(▼-2) — TSMC/ASML Q2 서프라이즈로 완화 | N2/A16 램프 1분기+ 지연 · High-NA 삽입 지연 | HBM -0.43EB (-14.9%) |
| CAPEX/ROI | **40 Yellow**(보합) — 실적시즌(07-22~30) 대기 | capex 가이드 -15% · FCF/CapEx <0.8 · HY OAS 급등 | **HBM -0.91EB (-31.5%)** |

**하방 위험 순서 불변: CAPEX/ROI > 전력 ≈ 패키징 > 파운드리. 전력은 3개 분기 연속 재상승(68→70→72→75)으로 4대 병목 중 유일하게 Red 밴드 진입.**
...
**상류 드라이버 트리 (2026-06-11 확장, 2026-07-21 최신)**: 각 병목에 영향을 주는 상류 요소를 depth 1(중류)·depth 2(상류)로 분해해 선행시차만큼 먼저 인지한다 — 예: CAPEX ← 하이퍼스케일러 이익·FCF(d1, 2~4분기 선행) ← **AI 기업 매출·이익(OpenAI·Anthropic·xAI·Google)**(d2, 12~18개월 선행). 22개 드라이버의 가중 롤업으로 병목별 선행 압력(상류/중류)을 산출하고, 현재 지수와의 괴리로 조기경보(악화 예고·완화 예고·상류-중류 괴리)를 발동한다. 2026-07-21 판독: 전력은 계통 접속(d1)·변압기(d2) 모두 '임계' 압력 지속 — 3개 분기 연속 지수 상승과 정합. CAPEX는 중류(가이던스 재확인)가 조용하나 상류(GPU 임대가·자금조달)가 여전히 긴장 — 실적시즌(07-22~30) 결과 대기. 모델 구조 도식(상류→병목→min()→수급)이 탭 상단에 내장되어 있으며, 수요 변곡 EWI는 프레임 일관성을 위해 같은 탭의 별도 서브탭으로 분리 운영한다(모델 화면에는 비표출).
