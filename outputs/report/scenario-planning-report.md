...
**작성일**: 2026년 5월 6일 (Q1 2026 실적 + 벤치마크 통합 업데이트) | **최종 데이터 갱신**: 2026년 8월 25일 (병목 모델 5차 정기점검 + SK하이닉스-NVIDIA $500B LOI·Micron-GM SCA 반영)
...
### 핵심 수치 한눈에 (2026년 8월 25일 최신)

| 항목 | 수치 | 시사점 |
|------|------|---------|
| Samsung 2026 Q2 실적 (2026-07-31) | 연결 매출 171.5조 원(QoQ+28%)·영업이익 89.5조 원(QoQ+56%, 역대 최고), DS부문 매출 127.5조 원·영업이익 약 89조 원 | 호황의 정점·ROI 실현 재확인. HBM4E 샘플 업계 최초 출하, 3Q26 HBM4 매출 전분기 3배+ 가이던스 |
| **SK하이닉스 2026 Q2 실적 (2026-07-29)** | 매출 79.32조 원(YoY+257%)·영업이익 60.54조 원(YoY+557%, 역대 최고이나 컨센서스 하회로 주가 하락) | **NVIDIA와 $500B+ 전략적 파트너십 LOI(2026-07-25)** — AI 팩토리+HBM4 공동개발·장기공급, 지금까지 최대 규모 SCA형 계약 |
| **Micron-GM SCA (신규, 2026-07-01)** | SCA가 반도체·AI 인프라 밖 완성차 산업으로 최초 확산. SCA 고객 16곳(DRAM 물량 ~20%·NAND ~1/3, 확보액 ~$22B) | LTA→SCA 전환이 "규모"(SK-NVIDIA)와 "범위"(Micron-GM) 두 방향으로 동시 심화 |
| 빅테크 4사 AI CapEx 2026 | **$725B**(+77% YoY, Amazon $220B·Google $195~205B·Meta 하한 $130~145B 추가 상향) | Dell'Oro 2030 $1.7조·JPMorgan 2030 누적 $5.5조. 단 Alphabet 첫 FCF 마이너스·Meta 주가 -10% — ROI 인내심 약화 신규 리스크 |
| HBM4 NVIDIA Rubin 공급 (배정 추정, 매체별 편차 확대) | SK하이닉스 50%대~70%·삼성 20%대·Micron 20%대(매체별 편차, NVIDIA 공식치 미공개) | Rubin 2026년 출하 20~30만대 그치고 대부분 2027 이월 — 배정 확정은 여전히 지연 |
| **삼성 HBM4 수율 80% (TrendForce 2026-08-10)** | 2월 양산개시 60%미만 → 80%로 상승, 연말 목표 조기 달성. HBM 웨이퍼 캐파 17만→25만wpm(+47%) | 패키징·파운드리 유효산출 개선에 직접 기여 |
| DRAM/NAND 가격(TrendForce, 2026-07) | 3Q26 서버 DRAM **+13~18% QoQ**(장기계약 캡)·NAND **+10~15% QoQ**(둔화 지속) | Q4 2026 전망은 미확인 — 다음 정기점검 확인 대상 |
| **4대 병목 제약지수 (2026-08-25, 이전 07-04 대비)** | 전력 **75**(▲+3) · CAPEX **38**(▼-2) · 파운드리 **49**(▼-1) · 패키징 **64**(▼-3) | 전력 5개 분기 연속 악화(ERCOT 승인률 저조·변압기 128주)로 4대 병목 중 최고. 패키징이 가장 빠르게 완화(CoWoS 갭 20%→10%) |
| DRAM 시장점유율 (Counterpoint Q2 2026, 확정) | **삼성 39%(1위 탈환)**·SK하이닉스 26%·Micron 25%(격차 1%p)·CXMT 7% | SK하이닉스 YoY매출+214%에도 점유율 39%→26% 하락(시장이 더 빨리 성장) |
| HBM 점유율 (Q2 2026, 상충 데이터) | 4월 삼성 35~40%(Counterpoint 계열 잠정) vs Q2 저품질 출처 SK 62%·삼성 17% — **원출처 미확인, 재확인 필요** | UBS(07-31): 삼성이 2027년 HBM 왕좌 탈환 가능 전망 — 정성적 방향은 정합, 정량치는 미검증 |
| **DRAM 반독점 집단소송** | 2026-08-08 기준 여전히 초기 단계(기각신청·판결·합의 전무) | 규제·평판 리스크 잠재 상태 유지, 실질 진전 없음 |
| TSMC 2026 Q2 실적 (2026-07-16) | 매출 $40.2B·HPC매출비중 66%·N2 웨이퍼매출 첫 기여(3%)·2026 CapEx $60~64B로 상향 | CoWoS 수급갭 20%→10%로 연내 축소(TrendForce), 14-reticle 양산은 2028년 유지 |
| Micron 미국 캐파 | 10% → 40% (10년) $200B 약정. FY26 HBM 공급 전량 완판, FQ4 가이던스 매출 $50B±$1B | 미국 메모리 자급 비중 상승 — 시나리오 A 강화 |
| CXMT·YMTC (신규) | CXMT 상하이 신공장 2026 하반기 장비반입(2027 양산 목표). **YMTC 우한 3공장 절반 DRAM 할당** — NAND 전업에서 DRAM 진출 신호 | 중국 경쟁 구도가 DRAM 축으로 확장 — 위협 다변화 |
| 텍사스 테일러 | 2공장 착공 2026년말로 앞당김, 1공장 2026말~2027초 가동. CHIPS 보조금 $4.745B 확정 | 미국 캐파 가속 — 시나리오 A 실행력 강화 |
| 한국 국가 반도체 생태계 계획 (2026-06-29) | 약 800조 원($518B), 삼성·SK하이닉스 각각 신규 팹 2개 | 국내 정책 지원 확대 — MB2·SA2 실행 여건 개선 |

> 최신 데이터 출처: [sources/raw-notes/bottleneck-model-update-2026-08-25.md](../../sources/raw-notes/bottleneck-model-update-2026-08-25.md), [sources/raw-notes/memory-market-strategy-update-2026-08-25.md](../../sources/raw-notes/memory-market-strategy-update-2026-08-25.md) (SemiAnalysis·Counterpoint·TechInsights 등)
...
#### 2.2.3 [정기점검] 2026-08-25 시장 업데이트 — 전력망 5분기 연속 악화·SK하이닉스-NVIDIA $500B LOI·SCA 산업 밖 확산

SemiAnalysis·Counterpoint·TechInsights를 우선 참조하고 TSMC·ASML·ERCOT/PJM 1차 공시·TrendForce 등으로 보강한 정기 점검(2026-08-25, 이전 점검 2026-07-04 대비).

- **병목 모델 4대 제약지수 갱신**: 전력 72→**75**(▲+3, ERCOT 1분기 신규 접속신청 198GW vs 실제 승인 9,062MW뿐로 승인률 저조 신규 확인·변압기 리드타임 128주로 재연장), CAPEX/ROI 40→**38**(▼-2, 빅4 합산 $725B로 추가 상향·HY OAS 275bp 최저이나 Alphabet 첫 FCF 마이너스·Meta 주가 -10%로 투자자 인내심 약화 조짐), 파운드리 50→**49**(▼-1, TSMC N2 웨이퍼매출 첫 기여·CapEx $60~64B 상향이나 HPC 매출비중 66%로 완화 속도 정체), 패키징 67→**64**(▼-3, CoWoS 수급갭 20%→10% 축소·삼성 HBM 캐파 +47%·Rubin 물량 2027 이월로 4대 병목 중 가장 빠른 완화). **전력이 5개 분기 연속 악화한 유일한 축으로 4대 병목 중 현재 지수 최고** — 상세: [wiki/concepts/bottleneck-model-2030.md §종합 판독(2026-08-25)](../../wiki/concepts/bottleneck-model-2030.md).
- **SK하이닉스-NVIDIA $500B+ 전략적 파트너십 LOI(2026-07-25)**: AI 팩토리(SK텔레콤 2GW Vera Rubin DSX, 2027년 1단계 가동)와 HBM4 공동개발·장기공급을 묶은 지금까지 최대 규모 SCA형 계약. Micron-GM SCA(2026-07-01, 완성차向 — SCA가 AI 인프라 밖 산업으로 최초 확산)와 함께 계약 구조 진화(LTA→SCA)가 규모·범위 두 방향으로 동시 심화([wiki/concepts/lta-to-sca-transition.md](../../wiki/concepts/lta-to-sca-transition.md) [Update 2026-08-25]).
- **삼성 대응 신호**: AMD-삼성 HBM4 공급계약 "거의 완료" 단계(2026-07-24), 텍사스 테일러 2공장 착공 2026년말로 앞당김, FMS 2026(8/4~6)에서 차세대 3D 메모리(zHBM·zNAND-O)·연산 내장형 aHBM 구상 공개. 2026 Q2 실적 역대 최고(DS부문 영업이익 약 89조원)이나 HBM 점유율은 데이터 상충 — Q2 저품질 2차 출처는 SK하이닉스 62%·삼성 17%로 기존 위키치(4월 35~40%)와 정면 배치, 원출처 미확인으로 병기 처리([wiki/concepts/hbm-market.md](../../wiki/concepts/hbm-market.md) [Update 2026-08-25]).
- **DRAM 시장점유율(Counterpoint, Q2 2026)**: 매출 기준 삼성 39%(1위 탈환)·SK하이닉스 26%·Micron 25%(격차 1%p)·CXMT 7%(4위권 부상, 매출 계열 첫 확정치).
- **DRAM/NAND 가격**: TrendForce 3Q26 서버 DRAM +13~18% QoQ(장기계약 캡, 기존 전망 유지)·NAND +10~15% QoQ(둔화 지속). 삼성 HBM4 수율 60%→80%(2026-08-10)로 연말 목표 조기 달성.
- **반독점 소송**: 2026-08-08 기준 초기 단계 그대로(기각신청·판결·합의 전무) — 규제 리스크는 잠재 상태 유지, 실질 진전 없음.

> 1차 자료: [sources/raw-notes/bottleneck-model-update-2026-08-25.md](../../sources/raw-notes/bottleneck-model-update-2026-08-25.md), [sources/raw-notes/memory-market-strategy-update-2026-08-25.md](../../sources/raw-notes/memory-market-strategy-update-2026-08-25.md)
