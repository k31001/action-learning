...
| 2 | 요구사항과 역량 · 기술 전략 | QLC가 캐시 티어에 들어가려면 디바이스에서 고객 시스템 안까지 세 단계로 올라가야 합니다 | 상: 갭 타일 4(숫자 + 한 줄) / 중: Phase 1·2·3 **스택 그림**(고객 시스템 5계층 중 우리가 닿는 층을 색으로, 트레이스·정책 화살표, 상주 아이콘, 진행 바에 삼성 현 위치) / 하: 협업 기업 로고 5층(라벨만) |
| 3 | 실행 전략 · 고객 협업 | 고객의 워크로드를 받고 고객 시스템 안으로 들어갑니다. 조직·보상·계약이 그 길을 엽니다 | 중앙 **교환 그림**(삼성 개발실 ↔ 고객 시스템 스택, 위 화살표 "우리가 들어간다", 아래 화살표 "워크로드가 온다", 가운데 계약 자물쇠·창 2027 H1) + 대상 로고 스트립 / 하: 5축 타일(한 줄) + 90일·1년·3년 핀 + 결정 요청 |
