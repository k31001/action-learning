...
**인사**: 별도 보상(자회사 지분·RSU형, SV 시니어 시장가 $600~700K대; SK hynix 자사주 성과급·ADR 상장, 삼성 국내 특별성과급 상향 리셋), 고객·생태계 출신 앵커 영입(하이퍼스케일러 스토리지팀·NVIDIA DevTech, LMCache·FlexKV·Mooncake 커미터, 커널·XFS 메인테이너), 본사 펌웨어 엔지니어의 고객 상주 로테이션(6~12개월), 호명되는 전문가 트랙(미국 고객이 인식하는 직함·논문·업스트림 KPI). 스타트업 팀 인수는 제외하고 시장 기준가(Astera↔Pliops 약 $70M/60명)만 참고한다.
...
| 티어 | 액션 | 산출물 |
|---|---|---|
| **즉시(90일)** | I-1 KV-ready QLC 제품 정의(RUH 200+·수명 보증 조건표·로드맵 공개) · I-2 LMCache·FlexKV write stream PR + KV cache WAF·유효 DWPD 실측 백서 · I-3 Anthropic 공급계약 공동 최적화 조항 제안 · I-4 NVIDIA DOCA Memos 힌트 매핑·STX 인증 협의 · I-5 DDN 라운드 참여 검토 · I-6 자회사 설계안(법인·보상·지분·P&L) · I-7 Co-Design Pod 1호 발족(등대 고객 1사, 로테이션 1기) | 제품 정의서, PR 2건, 백서, 계약 부속서 초안, 투자 심의 안건, 이사회 안건, Pod 헌장 |
| **1년(2027 Q3까지)** | Y-1 자회사 출범·스타 앵커 3명+ · Y-2 고객·생태계 출신 앵커 영입 + 로테이션 1기 복귀 · Y-3 등대 고객 2사 Pod 상주, 프로파일 3종·수명 보증 조건표 공개 · Y-4 공동 플랫폼 계약 1건 · Y-5 CMX/STX 인증·기본 백엔드 지위 · Y-6 시스템 TCO 모델 v1 · Y-7 수명 보증+TCO 연동 상품 출시 | 법인·영입·계약·인증·모델·상품 |
...
가성비 판정: 업스트림 PR·실측 공개(인건비 수준, 즉시 회수)와 Co-Design Pod 상주(Pod당 3~5명, 워크로드·시스템 접근을 동시에 연다)가 최고, KV-ready QLC는 필수, 자회사(초기 100~200명, 인건비 연 $100~150M 추정)는 높음, DDN 지분은 중간, 수명 보증 상품은 높음(프리미엄 근거). 상세 [qlc-execution-strategy.md](../../wiki/strategies/qlc-execution-strategy.md) §3.4.
...
| 3 | 실행 전략 · 고객 협업 | FDE로 고객 시스템 안에 들어가고, 전략적 협약으로 워크로드를 받습니다. 선례는 이미 있습니다 | 중앙 **두 트랙 그림**(삼성 개발실 ↔ 고객 시스템 스택, 위 화살표 "① FDE가 들어간다", 아래 화살표 "② SCA로 워크로드가 온다", 가운데 **선례 카드 2**: Palantir FDE(상주 엔지니어 그림 + 파급) · Micron↔Anthropic SCA(계약 4요소 블록 + 16건·$100B·$22B)) / 하: 5축 타일 + 90일·1년·3년 핀 + 결정 요청 |
