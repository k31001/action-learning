...
| 5 | ⑤ 실행 · 누구와 어디서 | 3단계 진입은 워크로드를 개방하는 고객에 FDE를 집중하고, 그 외는 업스트림·규격으로 협업합니다 | **두 트랙 그림(v6.2)** — 좌 삼성 개발실 / ① FDE 상주 → · 고객 선별·선례 카드 · ← ② 접근권 확보 / 우 고객 시스템 계층 + 조직·인사·문화 + 판돈·비용 (5장). 단계별 통과 조건은 덱에서 제외하고 §5.4에 유지 |
