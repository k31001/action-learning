...
| `outputs/presentation/qlc-ssd-strategy-outline.md` · `scripts/generate_qlc_ssd_strategy_pptx.py` · `qlc-ssd-strategy.pptx` | 4장 덱(v4.0 순서 재편: 교훈·문제 → 해법 사다리 → 역량 → 실행) |

## PPT 압축 맵 (4장 덱, v4.0 스토리라인: ① 교훈·문제 → ② 해법 사다리 → ③ 역량 → ④ 실행)
...
| # | 스토리 레일 | 액션 타이틀 | 본문 |
|---|---|---|---|
| 1 | ① 교훈 · 문제 · 왜 지금, 무엇이 필요한가 | 다운턴의 교훈은 고객 요구 적중이고, AI 수요는 요구를 대용량·높은 DWPD로 이동시킵니다 | 다운턴 타임라인(DT19·DT23 + QLC 이정표) → 교훈 카드 3(수요 센싱 2년 / 고객 협업 12개월 / 의사결정 시점 2027H2, 도식 + 연결 칩) + 문제 제기 패널(요구의 이동 3국면 · 10배·350EB·10~40배 · "대용량 QLC로 1~3 DWPD를 충족할 해법이 필요" · 송용호 인용) → 결론 → ② (본문 §1.0·§2.4) |
