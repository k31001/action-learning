...
| 3 | 실행 전략 · 고객 협업 | FDE로 고객 시스템 안에 들어가고, 전략적 협약으로 워크로드를 받습니다. 선례는 이미 있습니다 | 중앙 **두 트랙 그림**(삼성 개발실 ↔ 고객 시스템 스택, 위 화살표 "① FDE가 들어간다", 아래 화살표 "② SCA로 워크로드가 온다", 가운데 **선례 카드 2**: Palantir FDE(상주 엔지니어 그림 + 파급) · Micron↔Anthropic SCA(계약 4요소 블록 + 16건·$100B·$22B)) / 하: 5축 타일(축당 3줄 — 인사: 시스템 SW 전문가 채용·양성 / 기준: 고객 시스템 이해 / 미주 현지 채용 확대·별도 보상, 문화: 오픈소스 생태계를 주도 / 메인테이너·커미터 배출 / 업스트림 우선·실측 공개, 조직: 자회사 / FDE Pod / 시스템 SW 조직 강화) + 90일·1년·3년 핀 + 결정 요청(자회사·별도 보상·미주 현지 채용 승인 / Anthropic SCA 조항·NVIDIA 협의 / FDE Pod 1호) |
