...
| `outputs/presentation/qlc-ssd-strategy-outline.md` · `scripts/generate_qlc_ssd_strategy_pptx.py` · `qlc-ssd-strategy.pptx` | 6장 덱(v5.2: 문제 → 신뢰성 → 해법 사다리 → 역량 → 실행 → 보증·SLA, 제목 문단) |
