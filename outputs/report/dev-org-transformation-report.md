...
| 축 | 핵심 조치 | 목적 |
|---|---|---|
| **기술** | 워크로드 랩 신설 · 커스텀 설계 플랫폼화 · 임베디드 SW 스택 | 공동 최적화 제안의 기술적 기반 |
| **문화** | "정답 구현"→"가설 제안" · 실패 허용 예산 · 트레이드오프 토론 표준화 | 선제 제안이 보상받는 행동 체계 |
| **조직** | 고객별 Co-Design Pod · 워크로드 인텔리전스 기능 · 기술 마케팅 승격 | 개발 엔지니어를 고객 아키텍트 옆으로 |
...
### Phase 1 · 90일 (증명): 파일럿 고객 1사 Co-Design Pod 발족, 워크로드 랩 최소 구성, 선제 제안 1호 제출, KPI 개정안 설계
### Phase 2 · 1년 (제도화): Pod 3~5개 확대, 로드맵 교차 리뷰 정례화, PoA 연 4회, 개정 KPI 전면 적용, **SCA형 계약 1건 이상 수주**
### Phase 3 · 3년 (표준화): 커스텀 설계 플랫폼 완성(리드타임 50%↓), "전략적 인프라 파트너" IR 공시 수준 도달, 임베디드 SW 별도 P&L
