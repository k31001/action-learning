...
const F = '맑은 고딕';
const RAD = 0.08;
const TOTAL = 22;   // 표지 + 본문 14 + 2차 저지선 6 + 별첨 1
...
// ════════════════════════════════════════════════════════════════════════
{
  ...
  tx(s, '2차 저지선 상세 — S16 ~ S21', { x: 6.17, y: 5.58, w: 6.5, h: 0.62, fontSize: 20, bold: true, color: C.NAVY, align: 'center', valign: 'middle' });
...
// ════════════════════════════════════════════════════════════════════════
// S16 — 2차 저지선 섹션 도입 (골격만 · 내용은 작성자가 채운다)
// ════════════════════════════════════════════════════════════════════════
{
  const s = blankSlide(16, '제2 저지선 — 무엇을 지키는가');
...
// ════════════════════════════════════════════════════════════════════════
{
  const s = blankSlide(21, '전략 3번 · (제목 미정)');
...
// ════════════════════════════════════════════════════════════════════════
{
  const s = contentSlide(22, '별첨 · DS 전사로 넓히면',
