...
| 3 | 실행 전략 · 고객 협업 | FDE로 고객 시스템 안에 들어가고, 전략적 협약으로 워크로드를 받습니다. 선례는 이미 있습니다 | **두 트랙 그림(v3)**: 좌 「삼성 개발실」(KV-ready QLC·FDE·업스트림 코드·공급/자본) ↔ 우 「고객 시스템」 스택(캐시 관리자에 FDE 아이콘, I/O·커널 머지, SSD 삼성 QLC, 하단 로고). 가운데 위 화살표 "① FDE가 고객 시스템 안으로 들어간다", 아래 화살표 "② 전략적 협약(SCA)으로 워크로드가 온다 · 창은 2027 상반기". 두 화살표 사이 **선례 카드 2**: Palantir FDE(엔지니어 3명 → 고객 현장 그림, 코드명 Delta·성과 평가, 파급: 락인·640%·Anthropic/OpenAI GTM 채택) · Micron↔Anthropic SCA 2026-06(공동 설계·다년 공급·운영 통합·자본 4블록, 16건·$100B·$22B, 삼성·SK 계약엔 공동 설계 조항 없음 → 우리가 제안). → **5축 타일** → 90일·1년·3년 핀(SCA 조항·FDE Pod) → 결정 요청(자회사·별도 보상 / Anthropic SCA 공동 설계 조항·NVIDIA 협의 / FDE Pod 1호) |
