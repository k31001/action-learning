...
- NEXT STEP: 메모리 처우 급등 국면 = 스타(DE) 영입·유지 적기 → 90일 Pod·DE 트랙 설계 → 1년 SCA 1건·DE 1호
- 스타 엔지니어(Distinguished Engineer) 논거: 송길영 『호명사회』(조직→개인 이름) + 메모리 성과급 급등(삼성 ~6억·SK 상한철폐)으로 채용 협상 우위 — 상세는 보고서/대시보드가 담당
