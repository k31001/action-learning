...
- [wiki/concepts/codesign-demand-lesson.md](wiki/concepts/codesign-demand-lesson.md) — design-in을 가른 것: **표준 충족과 고객 사양은 다른 선이었다**(JEDEC HBM4 최대 8Gbps 대 NVIDIA 요구 10~13Gbps). 표준 제정 참여는 변수가 아니었다(9개사 공동 개발). 중립 기록표와 **쓰지 않기로 한 표현 4종**("시장을 작게 봤다"·"조직 축소"·"5년 공백"·내부 판단 서술 — 해석이거나 팩트체크 불가) + 반증 4
