...
- [sources/articles/mad-podcast-dylan-patel-memory-2026-07.md](sources/articles/mad-podcast-dylan-patel-memory-2026-07.md) — MAD Podcast(Matt Turck)×Dylan Patel(SemiAnalysis, 2026-07): 메모리 다년 구조적 부족·가격 상방 2~3배·진짜 증분 공급 2028(팹 연 +20~30% 한계)·KV 캐시 수요 메커니즘·컨슈머 전치·Anthropic FCF 전환 주장($50B+ 연환산)·CPO 양산 2029 지연(Street 2027)·구리 붐 연장·NVIDIA 800V (2차 보도 3건 교차 수집, 대시보드 "인터뷰" 메뉴 미러)
...
- [outputs/presentation/dev-transformation-summary.pptx](outputs/presentation/dev-transformation-summary.pptx) — 개발실 체질 전환 1장 요약 × 디테일 3단계(상·중·하), 도식 중심(타임라인·As-Is→To-Be·아이콘)·화이트+블루·그린. 1장짜리 개별본 `-high/-mid/-low.pptx` + `dashboard/public/downloads/` 다운로드 미러 (`scripts/generate_dev_transformation_summary.cjs`로 재생성)
