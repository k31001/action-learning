...
- [outputs/presentation/qlc-ssd-strategy.pptx](outputs/presentation/qlc-ssd-strategy.pptx) — (NEW) QLC eSSD 전략 **3장** 덱 본체 — S1 3기 카드+통합 그래프(EB·%·$B)+스티커 / S2 갭 타일 4+Phase 그리드+협업 기업 로고 5층 / S3 5축 카드+3티어+층별 협업 제안+결정 요청 (`scripts/generate_qlc_ssd_strategy_pptx.py`, 그래프는 `scripts/generate_qlc_chart.py`, 커밋 예외 등록)
