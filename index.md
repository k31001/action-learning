...
- [wiki/concepts/essd-purchase-criteria-shift.md](wiki/concepts/essd-purchase-criteria-shift.md) — (NEW) eSSD 구매 기준의 이동: 성능(2008~12) → QoS·지연 꼬리(2012~21, OCP v2.0 Latency Monitor 의무화) → 용량 밀도·전력 효율·공급 확보(2022~26). 내구성은 0.3과 60 DWPD로 양극화했고 추론 캐시 계층에서만 구속 조건. 정격 DWPD 57배↓ 대 드라이브당 허용 기입량 67배↑. SSD 관점 구매 지표 목록
