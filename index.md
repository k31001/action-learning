...
- [sources/articles/august-2026-market-update-2026-08-18.md](sources/articles/august-2026-market-update-2026-08-18.md) — (NEW) 2026-08-18 정기 점검(SemiAnalysis·TrendForce·Counterpoint 우선 수집): ERCOT 데이터센터 접속 사실상 일시 동결(250~300개 프로젝트·200GW 감사)·SemiAnalysis PJM 용량경매 모델링 결함 지적($120억 낭비)·HBM4 가격 $31~36/GB·삼성 HBM4 수율 80%·NAND Top5 매출 +77% QoQ·스마트폰 출하 2Q26 -11%(연간 전망 -2.1%→-14%)
- [sources/articles/samsung-sk-micron-nvidia-china-update-2026-08-18.md](sources/articles/samsung-sk-micron-nvidia-china-update-2026-08-18.md) — (NEW) 2026-08-18 기업별 동향: 삼성 베트남 레거시 후공정 이전 검토·H1 R&D+CAPEX 최대, SK하이닉스 나스닥 상장 완료·HBM4 램프 자발 감속, Micron Q4 가이던스·HBM4E 커스텀 시대, NVIDIA Rubin Ultra 메모리 하향 검토·FMS 2026(cuFile·SCADA), CXMT IPO 폭등·애플 인증 테스트·의회 압박
