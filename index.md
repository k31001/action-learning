...
- [sources/raw-notes/hot-chips-2026-hbm-architecture-2026-08-25.md](sources/raw-notes/hot-chips-2026-hbm-architecture-2026-08-25.md) — (NEW) Hot Chips 2026 웹 리서치: 삼성 zHBM(베이스다이 로직화, 전력효율+70%·대역폭+230% 주장) vs SK하이닉스 i-HBM(패키징·열관리, 열저항-30%+) 기술 전략 분기 + 하이브리드본딩 HBM5로 순연·775마이크론 높이 한계
