...
## [Update 2026-07-21] 상하이 STAR Market IPO $4.1~4.3B + BIS 등재 보류 + 의회 반발

### 상하이 IPO — 2026년 중국 A주 최대 규모

- **CXMT가 2026-07-16 상하이 STAR Market에 상장**, 약 **$4.1~4.3B** 조달 — 2026년 중국 A주 최대 IPO. Q1 2026 매출 약 **$7.3B(+700% YoY)**로 급성장 재확인.
- **텐센트와 다년 서버 DRAM 공급계약**(약 200억 위안/$3B, 2026-06 보도) — CXMT의 하이퍼스케일러 인증 진전(2026-05-19 업데이트에서 제안한 EWI ④ "하이퍼스케일러 인증 시도"의 구체적 실현 사례).
- **HBM 로드맵**: 2026년 말까지 HBM3 양산 목표는 유지하나, **경쟁력 있는 수율 확보는 2028년 이후**가 현실적이라는 평가 유지 — 07-04 업데이트의 "HBM 웨이퍼 배정 월 3만 장(2026년 말)" 전망과 정합(캐파 확대 ≠ 수율·품질 경쟁력).

### BIS Entity List 등재 보류 (신규 — 애플 로비와 같은 방향)

- 트럼프 행정부가 CXMT의 BIS Entity List 추가를 **미중 무역협상과 연계해 보류**(The Register·FT, 2026-07-17) — 07-11 업데이트에서 반영한 "로이터: 추가 블랙리스트 등재 보류" 신호를 재확인·구체화. 애플–CXMT 로비([samsung.md](samsung.md) 및 [us-export-controls.md](../concepts/us-export-controls.md#update-2026-07-11-1260h-리스트--애플cxmt-로비-2026-07))와 같은 디에스컬레이션 방향.

### 의회 반발 심화 (신규 — 상쇄 신호)

- 하원 미중전략경쟁특별위원회 위원장 존 물리너(Moolenaar)·조지 화이트사이즈(Whitesides) 의원이 상무장관에 서한(2026-07-17 전후) — CXMT Entity List 등재, YMTC 제재 확대, 애플 등 미국 기업의 CXMT/YMTC 구매 금지, 중국 군 연계 공급사 조달 금지 행정명령을 촉구.
- → **BIS 등재 보류(공존 방향)와 의회 반발(디커플링 방향)이 동시에 존재** — DF2 리트머스는 여전히 미해결. 순 방향 신호로 보기보다 "긴장 지속" 상태로 판단, DF2는 직전 재평가(0.5)를 유지([key-drivers.md](../driving-forces/key-drivers.md)).

### Samsung 전략 시사점

1. **프리미엄 고객·자본시장 접근성 동시 확대** — 텐센트 공급계약(프리미엄 고객)과 상하이 IPO(자본 조달)가 겹치며 CXMT의 확장 속도가 정책 리스크와 무관하게 가속. [RS-4 고객 포트폴리오 분산](../strategies/invariant/rs4-customer-portfolio-diversification.md)의 긴급성 재확인.
2. **HBM 진출은 여전히 시간 문제** — 2028년 이후 경쟁력 확보 평가가 유지되므로, 삼성·SK·Micron의 HBM4/HBM4E/HBM5 리더십 방어 창구(2026~2028)가 CXMT 위협 이전의 "골든 윈도우"라는 기존 판단 불변.
