...
sources: [sources/README.md (Digitimes, Tom's Hardware, TechInsights, Yole Group, Bloomberg, Reuters), sources/articles/ymtc-nand-top3-ipo-2027-target-2026-08-28.md]
---
...
| Q1 2026 | 3위 (TrendForce) | 매출·출하 모두 글로벌 3위·중국 1위 — IPO 신청서 인용 ([ymtc-nand-top3-ipo-2027-target-2026-08-28.md](../../sources/articles/ymtc-nand-top3-ipo-2027-target-2026-08-28.md)) |
| **Q2 2026** | **14% — 사상 첫 3위 (Counterpoint)** | Kioxia 제침. 삼성 25%·SK하이닉스 22%에 이은 3위. 출하 +22% YoY. 단, **매출 기준은 5위** (컨슈머 편중 믹스) |

매출 실적: Q1 2026 매출 470.4억 위안·순이익 333.8억 위안 — 2025년 연간 순이익(142.1억 위안)의 2배 이상을 한 분기에. ASP +173%(2025 평균 대비), GM 76.8% ([ymtc-nand-top3-ipo-2027-target-2026-08-28.md](../../sources/articles/ymtc-nand-top3-ipo-2027-target-2026-08-28.md))
...
## [Update 2026-08-28] 낸드 출하 3위 등극 + IPO 330억 위안 + "2027년 말 1위" 선언

전 항목 출처: [ymtc-nand-top3-ipo-2027-target-2026-08-28.md](../../sources/articles/ymtc-nand-top3-ipo-2027-target-2026-08-28.md)

### 3위 등극 — 그러나 '빗 3위·달러 5위'

- Counterpoint Q2 2026: YMTC 출하(빗) 점유율 **14%로 Kioxia를 제치고 사상 첫 글로벌 3위** (삼성 25%·SK하이닉스 22%). 2021년 4.8%에서 5년 새 약 3배.
- **매출 기준은 여전히 5위** (Micron·Kioxia에 뒤짐) — 컨슈머 중심 믹스, 고가 DC eSSD 비중 낮음. 서버 eSSD가 전체 낸드 출하의 48%인 시장에서 가치 사다리 하단에 위치.

### IPO와 자금 자립

- 모회사 CCSH, 상하이 STAR 마켓 **330억 위안(~6.8조 원)** IPO 신청 수리 (2026-08). 생산라인 업그레이드 208억 + R&D 122억 위안.
- Q1 2026 순이익 333.8억 위안 (GM 76.8%) — **보조금 의존을 넘어 슈퍼사이클 이익 + 공모자금으로 증설을 자급**하는 구조 전환. 빅펀드 III와 별개의 추가 재원.

### 캐파 로드맵 갱신

| 구분 | 캐파 | 상태 |
|------|------|------|
| 1·2공장 | 합산 ~20만 WSPM | 가동 중 |
| 3공장 | 2026년 말 가동 → 2027년 5만 WSPM | **국산 장비 50% 돌파** |
...
- 산술 체크: 설계 상한 50만 WSPM이 전부 가동돼도 삼성+Kioxia/SanDisk+SK+Micron 합산 캐파에 크게 못 미치며, 2027년 말까지 가동 가능한 것은 3공장 일부(+5만)뿐 → **2027년 빗 1위는 비현실적, 그러나 20% 안팎 진입은 시나리오로 성립**.

### 전략 함의 (요약)

기존 시사점 1~4에 더해: 추격의 실체는 "빗 점유율"이며 아직 "달러 점유율"이 아니다 → 삼성의 방어선은 빗 방어가 아니라 **가치 사다리(DC eSSD·인증·펌웨어 락인)와 세대 전환 경제학**. 종합 방어 전략은 [ymtc-nand-defense.md](../strategies/ymtc-nand-defense.md) 참조.
