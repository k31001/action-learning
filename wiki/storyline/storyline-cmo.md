...
> **범위 주기**: 이 절의 정밀 분해(CMO-1~3)는 1차·2차·3차를 다룬다. 2018 Q4~2019 다운사이클은 [CMO 통합 매트릭스](cmo-matrix.md)에 편입돼 있으며(대응 6건·대비 3건, §5.1의 P6 포함), 이 절의 정밀 CMO 구성 추가는 보류 상태다 — 통합 매트릭스의 판정을 우선 참조.
