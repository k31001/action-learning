...
## [Update 2026-06-30] 전력망 규제 격상 — PJM 용량권고·FERC 대형부하 요금 개혁·NERC Level 3 경보

- **PJM 용량권고(Capacity Advisory) 신메커니즘**(2026-06-24, Bloomberg): PJM(6,700만 명·13개 주 서비스)이 AI DC 부하발 그리드 부족이 극한 기상 시기 외에도 발생하는 상황에 대응해 새 경보 체계 도입.
- **FERC 명령**(2026-06): 미국 6개 RTO/ISO 전체에 대형부하(large-load) 전기요금 체계의 정당성·개혁안을 **60일 이내** 제출 의무화 — 규제기관이 사후 대응에서 선제 개입으로 전환.
- **ERCOT 거버넌스 승인**: NPRR1325·PGRR145 프레임워크 2026-06-01 이사회 승인, 2026-07-11 발효. 대규모 부하 접속 신청 **410GW+** 검토 중(2026-04 기준), **87%+가 데이터센터**.
- **NERC Level 3 Essential Actions Alert**(2026-05): 대형 연산 부하 대상 **2026-08-03 준수 기한**. 1MW+ DC가 20MW+/60kV+로 집계 시 "Computational Load Entity" 등록 의무화 제안 — 전력망 신뢰성 기관이 AI DC를 별도 규제 카테고리로 격상하는 첫 시도.
- **천연가스 발전 증설 속도 제약**: 미국 가스 발전 증설 **2026~2027년 연 10GW 미만**, 본격 증가는 **2028년 이후** — 단기 브리지 연료조차 속도 제약에 직면.
- **병목 모델 연결**: [bottleneck-model-2030.md](bottleneck-model-2030.md) §5 — 전력 제약지수 **70 → 72**(2026-06-30). `interconnect` 드라이버 '임계' 유지, 규제 격상이 단기 해소 가능성을 추가로 낮춤.
