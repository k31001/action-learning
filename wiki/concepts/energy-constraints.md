...
## [Update 2026-06-20] FERC 패스트트랙 승인 — 계통 접속 규제 병목 완화 첫 신호 (병목지수 70→69)

- **FERC 패스트트랙 승인(2026-06-18)**: 미국 연방에너지규제위원회(FERC)가 AI 데이터센터 그리드 연계 패스트트랙 절차를 공식 승인. Bloomberg: *"US Moves to Speed Grid Connections for AI Data Centers."*
- **의미**: 허가·행정 프로세스 단축 → 착공 선행. 그러나 물리적 그리드 공사·변압기 리드타임(18~36개월)·케이블 공급망은 단기 해소 불가 — 실질 완화 효과는 **2028년 이후** 기대.
- **WEF(2026-05)**: "전력 계통 접속이 AI 변환의 전략적 병목" — 전 세계 정책·산업계의 인식 수렴 확인.
- **병목 모델 연결**: 전력 제약지수 **70 → 69** 소폭 하향(2026-06-20) — FERC 패스트트랙은 규제 병목 완화의 최초 구체적 신호. `interconnect` 드라이버는 여전히 임계(90). 처음으로 하방 전환 — 경보 Orange(60~75) 유지.
