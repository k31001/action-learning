...
## [Update 2026-09-08] ERCOT 데이터센터 접속 전면 동결 — 정치·행정 리스크 신규 등장

- **2026-08-03**: 텍사스 주지사 Greg Abbott가 ERCOT의 데이터센터 신규 접속 승인을 **전면 일시중단**시키고 주 전체 감사를 지시(PUCT Docket 59220). ERCOT는 2026-12-10까지 감사 완료를 목표로 한다 — 위키가 지금까지 추적해온 "물리적 대기열·리드타임" 병목과는 성격이 다른 **정치·행정 리스크**가 처음으로 전력 제약에 추가됐다 ([september-2026-market-update-2026-09-08.md](../../sources/articles/september-2026-market-update-2026-09-08.md) §1).
- **ERCOT 대형부하 접속 큐**: 2026-03 410GW+ → 2026-08 **~474GW**(약 90%가 데이터센터)로 5개월 만에 추가 확대 — 동결 직전까지도 신청이 계속됐다.
- **PJM 2028/29 인도연도 용량경매 부족분**: 2026-07-14 발표 기준 **6,831MW 부족**(청산가 $325/MW-day 상한), 이전(2027/28) 6,623MW에서 예측 경로대로 소폭 확대 — 2030년까지 최대 15GW 구조적 부족 서사와 정합.
- **PJM 절차는 개선**: Cycle 1(811개 프로젝트·220GW) 처리 완료, ~46GW는 Transition Cycle 2로 이관해 2026년 말까지 스터디 완료 목표 — 신규 접속 프로세스 자체는 빨라졌으나(1~2년으로 단축) 이는 병목의 **성격 변화**이지 **해소**는 아니다.
- **변압기**: 고압/GSU급 리드타임은 100~150주(2~3년), 일부 자료는 여전히 5년대로 보고 — 정체. 배전용 평균은 2023년 피크(100주+) 대비 ~30주로 하락(등급별 양극화). 관세(2026-04-06 발효, 철강·알루미늄·구리 계층 관세)가 가격을 추가 압박(2019년 대비 배전용 +78~95%·발전용 +77%·GSU +45%).
- **BTM(자가발전) 실측**: 약 2GW가 실제 가동 중(xAI Colossus 1,498MW 등 4개 프로젝트) — SemiAnalysis의 "2028년까지 40GW+" 전망은 유지되나 현재 실측 규모는 초기 단계에 불과.
- **병목 모델 연결**: 전력 제약지수가 72 → **74**로 재상향(2026-09-08) — ERCOT 동결이 핵심 신규 근거. [bottleneck-model-2030.md](bottleneck-model-2030.md) §5 갱신 완료.

**출처**: [september-2026-market-update-2026-09-08.md](../../sources/articles/september-2026-market-update-2026-09-08.md) §1
