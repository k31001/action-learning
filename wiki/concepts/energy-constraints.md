...
## 업데이트 (2026-08-04) — PJM 용량경매 목표 미달 공식화 + 변압기 60개월 (병목지수 72→75)

- **PJM 2028/29 용량경매**: 134,478~138,318MW 확보에 그쳐 목표 예비율(20%) 대비 **14.4%로 미달**. PJM 이사회가 2026-07-27 **백스톱 경매 + 데이터센터 우선 감축(curtailment)안**을 제안 — 계통 운영기관 스스로 신뢰성 목표 미달을 공식화한 최초 사례(기존의 대기열·리드타임 악화라는 간접 신호와 질적으로 다른 단계) ([august-2026-market-update-2026-08-04.md](../../sources/articles/august-2026-market-update-2026-08-04.md)).
- **ERCOT 대기열**: 기존 410GW+에 신규 제출 ~140GW가 추가 대기 중 — 총 ~380GW 육박(일부 추정 445.8GW/2033). 최근 12개월 승인 가동은 ~9,062MW에 불과해 신청:증설 배율이 극도로 낮은 구조 지속.
- **설비 리드타임 재악화**: 변압기 리드타임이 기존 "최대 5년"에서 **최대 60개월**로 한 단계 더 확대, 개폐장치는 44주→**60주+**. 단일 공급원인 GOES(방향성 전기강판) 병목이 근본 원인으로 지목됨.
- **원자력/SMR**: 누적 커밋 9.8GW+(13건)로 확대되었으나 대부분 2028년 이후 가동 — 단기 완화 효과는 제한적. Crusoe+Aalo Atomics 파트너십(2026-07-30, Idaho National Lab) 등 신규 소형원자로 실증 프로젝트 지속.
- **병목 모델 연결**: 전력 제약지수 72 → **75**로 상향(2026-08-04) — 4대 병목 중 유일하게 3개 분기 연속 상승(70→72→75). [bottleneck-model-2030.md](bottleneck-model-2030.md) §5 갱신 완료.

**출처**: [august-2026-market-update-2026-08-04.md](../../sources/articles/august-2026-market-update-2026-08-04.md) §5
