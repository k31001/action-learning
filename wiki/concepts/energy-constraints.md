...
## [Update 2026-06-21] 변압기·스위치기어 공급망 위기 — 북버지니아 2030~2033 현실화 (병목지수 70→73)

- **변압기 리드타임 160주+**: 2023년 ~140주 → 2025년 ~150주 → 2026년 **160주 초과**(추가 악화). 스위치기어는 **2028년까지 납기 불가** — 접속 지연의 물리적 원인이 변압기 한 가지에서 스위치기어까지 다층화.
- **북버지니아 구체화**: 2026년 5월 이후 북버지니아 계통 접속 신청 시 실제 전력 공급 가능 시점 **2030~2033년**으로 구체화. "평균 8년 대기"가 특정 허브의 실제 시점으로 현실화됨.
- **2026년 AI DC 30~50% 지연·취소**: 2026년 가동 예정 AI 데이터센터 중 30~50%가 지연 또는 취소. 발표 용량(announced capacity)과 실제 가동 용량(deployed capacity)의 괴리 확대.
- **DOE 2030 전망 강화**: 2030년 미국 데이터센터 전력 비중 **12%**(현재 4%). 미국 전체 전력 소비의 12%가 DC로 — 전력 병목이 단기 조정 불가 구조임을 재확인.
- **병목 모델 연결**: 전력 제약지수 **70 → 73** 추가 상향(2026-06-21). `interconnect` 드라이버 임계(90) 유지, `transformer` 드라이버 리드타임 160주+ 갱신.
