...
## [Update 2026-09-15] 텍사스 ERCOT 신규 접속 전면 일시중단·PJM 대형부하 신규 규정 (병목지수 72→78)

- **텍사스 그리드 접속 정지**: Abbott 주지사가 2026-08-03(지시)·08-13(공식화) ERCOT의 신규 데이터센터 그리드 접속을 **감사 완료 시까지 전면 중단**시켰다 — 대상은 약 1,800개 프로젝트, 신청 총량 **474GW**(ERCOT 사상 최대 피크 수요의 5배 이상, 약 90%가 데이터센터). ERCOT은 감사에 "수개월" 소요를 예상했고, 감사 미준수 프로젝트는 접속이 거부된다 ([september-2026-market-update-2026-09-15.md](../../sources/articles/september-2026-market-update-2026-09-15.md) §1).
- **ERCOT Batch Zero 프로세스 지연**: 애초 2027-04-09 목표였던 대형부하 일괄 심사(Batch Zero)가 이미 목표를 놓쳤고 대체 일정은 미정. PUCT 감사 보고서 시한은 2026-12-10.
- **PJM 신규 대형부하 규정**(2026-08-13 FERC 제출): 2027-06-01 이후 신규 50MW+ 부하는 **자체 신규 발전을 확보하거나 Interim Resource Adequacy Service 비용을 부담**해야 하는, 업계 최고 수준으로 엄격한 규정. FERC 발효 희망일은 2026-10-12. 버지니아 북부 등 대형 AI 캠퍼스의 접속 대기는 최대 **약 7년**까지 확대. PJM의 2027~28 구조적 부족 전망(6.6GW)은 07-04와 불변.
- **질적 전환**: 07-04까지의 "큐 지연·리드타임 확대"에서, 09-15 시점은 미국 양대 전력시장(텍사스·PJM)에서 동시에 **정부·규제기관이 직접 신규 접속을 제한**하는 국면으로 전환 — "요금이 아니라 접속 자체의 물리적·정책적 한계"라는 본 페이지의 핵심 진단이 가장 극단적인 형태로 실현됨.
- **병목 모델 연결**: 전력 제약지수 **72 → 78**로 상향(2026-09-15, 3분기 연속 상승) — 4대 병목 중 최고 지수로 CAPEX/ROI(40)를 앞지름. [bottleneck-model-2030.md](bottleneck-model-2030.md) §5 `interconnect` 드라이버 노트 갱신 완료.

**출처**: [september-2026-market-update-2026-09-15.md](../../sources/articles/september-2026-market-update-2026-09-15.md) §1
