...
## [Update 2026-06-16] 전력 병목 구조 이동 — PJM 용량 부족·변전소 병목·ERCOT 급증 (병목지수 70→73)

### PJM 용량 경매 부족 (신규)
- **PJM 2025년 12월 용량경매**: **6,625 MW 부족** 공식 확인 — 공급이 수요를 충당하지 못함
- 2030년까지 **최대 15 GW** 누적 용량 부족 전망 (기존 "접속 지연"보다 직접적인 신뢰도 위협)

### 병목의 하류 이동 — 변전소·변압기 (신규)
- 그리드 병목이 **연계 대기열 → 변전소·고압 변압기**로 하류 이동
  - 대형 변압기·스위치기어·그리드-타이 배터리: **리드타임 5년**
- 인허가 후 실 가동 평균 소요: **7년 이상** (접속협약 3년 + 이후 4년)
- 하이퍼스케일러 대응: 공공 전력망 우회한 **"에너지 아일랜드"** (on-site 자가 발전) 구축 가속 — 공공망 한계를 시장이 인정한 신호

### ERCOT Q1 2026 급증 (신규)
- Q1 2026 단 한 분기: ERCOT에 대규모 부하 **198 GW 신규 연계 신청**
- 현재 ERCOT 부하 연계 대기열: **233 GW** (DC 70% 이상)
  - 1년 전 ~58 GW에서 **4배** 급증

### 병목 모델 연결: 전력 제약지수 **70 → 73** (▲+3, 2026-06-16)
- PJM 용량 부족: 기존 "접속 대기" → **"가동 중 신뢰도 위협"**으로 리스크 레벨 상승
- 변전소 5년 리드타임: 병목 해소에 추가 선행 경로 발생 — 계통 접속이 완료돼도 변전소가 없으면 DC 운영 불가
- ERCOT Q1 198GW: 수요 가속 구조적 재확인

**출처**: [june-2026-market-update-2026-06-16.md](../../sources/articles/june-2026-market-update-2026-06-16.md)
