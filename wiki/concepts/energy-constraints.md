...
| **Microsoft Azure 전력-제한 백로그** | **$80B** — "수요 약세 아닌 전력 부재가 원인" (2026-06-15 추가) | DataCenter Knowledge |
| **미국 유틸리티 5사 DC 에너지 투자** | **$1.4T (1.4조 달러)** 계획 발표 (2026-06-15 추가) | Tech-Insider |
| BTM(현장 자체발전) 비중 전망 | 2028년 DC 에너지의 **30%**가 현장발전 — 그리드 우회 구조화 (2026-06-15 추가) | Cleanview 2026-02 |
| FERC 대형부하 신속처리 | 2026-04-30 기한 지시 — 긍정적이나 공사 리드타임(7~13년) 단기 해소 불가 (2026-06-15 추가) | FERC |
| 미국 DC 전력 수요 궤적 | 23 GW(2023) → 42 GW(현재 2026) → ~76 GW(연말 예상) (2026-06-15 추가) | Axis Intelligence |
