...
## [Update 2026-09-15] 가이던스 불변·삭감 0건, 단 NVIDIA-OpenAI 파이낸싱 보증 축소로 조달 구조 스트레스

- **빅4 CAPEX**: 합산 ~$725B(+77% YoY) 가이던스·삭감 0건 불변(07-04 이후 변동 없음). 2027 전망이 애널리스트 사이에서 처음 **$1T대**로 진입(JPMorgan 등) — 07-04의 2030 누적 $5.5조와 별개로 단년 전망 자체가 상향.
- **NVIDIA↔OpenAI 오하이오 데이터센터 파이낸싱 축소(신규)**: NVIDIA가 검토하던 최대 보증액 **$250B**가 협상 과정에서 **<$120B**로, 최종 서명(2026-08-18)은 **$105B**(SEC 공시 "aggregate payment obligation" 상한)로 확정. NVIDIA는 초기 **5GW 구간만** 백스톱하고 잔여 구간 파이낸싱은 별도 결정 대기 — 투자자들이 NVIDIA 대차대조표의 과도한 노출을 우려해 축소를 압박한 것으로 보도됨 ([september-2026-market-update-2026-09-15.md](../../sources/articles/september-2026-market-update-2026-09-15.md) §2).
- **보강 신호**: Oracle 주가 YTD -24%. HSBC 분석: "OpenAI는 2030년 매출 $200B를 달성해도 추가 조달 ~$207B가 필요".
- **해석**: CAPEX 총량 자체의 컷이 아니라 **누가 리스크를 지는가**(파이낸싱 구조)의 재분배 신호 — 수요 붕괴 신호는 아니나, 병목 모델 CAPEX/ROI 축의 모니터링 항목으로 격상(지수 자체는 40으로 유지). [bottleneck-model-2030.md](bottleneck-model-2030.md) §5 CAPEX 드라이버 반영.

**출처**: [september-2026-market-update-2026-09-15.md](../../sources/articles/september-2026-market-update-2026-09-15.md) §2
