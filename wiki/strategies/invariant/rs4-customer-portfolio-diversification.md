...
## [Update 2026-07-11] 대칭 논리 — 애플–CXMT 건이 보여주는 "고객도 공급사를 분산한다"

RS-4는 메모리사가 고객을 분산하는 전략이지만, **거울상으로 고객(애플)도 공급사를 분산한다**는 사실이 2026-07 실증됐다. 애플이 중국 내수용 기기에 CXMT DRAM 테스트를 착수하고 미 행정부에 사용 승인을 로비 중 ([apple-cxmt-china-dram-2026-07-08.md](../../sources/articles/apple-cxmt-china-dram-2026-07-08.md)).

- **동기**: 2026년 초 범용 DRAM 계약가 +55~60% 급등 → 애플은 조달선 다변화·원가 압박 완화를 위해 삼성·SK·마이크론 **3강 외 제4 공급처(CXMT)**를 세운다.
- **실제 채택 규모**: 기술 격차 + 미 행정부 제동 우려로 중국 내수 보급형 소량에 그칠 공산 — 그러나 그 자체가 목적이 아니다.
- **진짜 효과 = price leverage**: 애플이 CXMT를 "제4 옵션"으로 세워둠으로써 장기계약 단가 협상에서 삼성·SK·마이크론을 압박하는 심리적 카드를 얻는다. 삼성·SK 과점 체제의 "균열 신호".

### RS-4에 주는 교훈

1. **단일 고객 ≤25% 목표(P4)의 재확인** — 애플처럼 조달 규모가 큰 고객일수록 공급사 분산 카드를 적극 쓴다. 애플 의존도가 높은 공급사는 이 leverage에 그대로 노출된다.
2. **LTA 단가 조정 조항(§3 L7, 시장가 ±15%)의 중요성 상승** — 고객이 저가 대안(CXMT)을 협상 카드로 쓸 때, 사전에 명문화된 조정 밴드가 있어야 스팟 협상에서 밀리지 않는다.
3. **바벨의 저가 축을 CXMT에 양보하되, 프리미엄 축(HBM·커스텀·고신뢰 LPDDR)에서 애플과 co-design 락인**([RS-3 고객 전환비용](rs3-customer-switching-cost.md)) 강화 — 애플이 CXMT로 대체할 수 없는 영역을 넓히는 것이 방어책.

**출처**: [apple-cxmt-china-dram-2026-07-08.md](../../sources/articles/apple-cxmt-china-dram-2026-07-08.md), [cxmt.md](../../entities/cxmt.md)
